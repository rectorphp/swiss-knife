...
class Interface_ extends \EasyCI20220308\PhpParser\Builder\Declaration
{
    protected $name;
    protected $extends = [];
    protected $constants = [];
    ...
    public function extend(...$interfaces)
    {
        foreach ($interfaces as $interface) {
            $this->extends[] = \EasyCI20220308\PhpParser\BuilderHelpers::normalizeName($interface);
        }
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220308\PhpParser\Node\Stmt\Interface_($this->name, ['extends' => $this->extends, 'stmts' => \array_merge($this->constants, $this->methods), 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
