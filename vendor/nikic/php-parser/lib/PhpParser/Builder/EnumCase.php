...
class EnumCase implements \EasyCI20220307\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->value = \EasyCI20220307\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220307\PhpParser\Node\Stmt\EnumCase($this->name, $this->value, $this->attributes, $this->attributeGroups);
    }
}
