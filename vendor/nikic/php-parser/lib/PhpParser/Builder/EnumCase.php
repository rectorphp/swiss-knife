...
class EnumCase implements \EasyCI20220517\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->value = \EasyCI20220517\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220517\PhpParser\Node\Stmt\EnumCase($this->name, $this->value, $this->attributes, $this->attributeGroups);
    }
}
