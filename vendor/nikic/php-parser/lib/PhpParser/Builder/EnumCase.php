...
class EnumCase implements \EasyCI20220418\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->value = \EasyCI20220418\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220418\PhpParser\Node\Stmt\EnumCase($this->name, $this->value, $this->attributes, $this->attributeGroups);
    }
}
