...
class EnumCase implements \EasyCI20220607\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->value = \EasyCI20220607\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220607\PhpParser\Node\Stmt\EnumCase($this->name, $this->value, $this->attributes, $this->attributeGroups);
    }
}
