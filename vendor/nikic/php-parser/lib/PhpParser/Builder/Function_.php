...
class Function_ extends \EasyCI20220509\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $stmts = [];
    ...
    {
        return new \EasyCI20220509\PhpParser\Node\Stmt\Function_($this->name, ['byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts, 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
