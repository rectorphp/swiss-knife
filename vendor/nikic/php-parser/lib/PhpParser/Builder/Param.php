...
class Param implements \EasyCI20220325\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \EasyCI20220325\PhpParser\Node\Param(new \EasyCI20220325\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
