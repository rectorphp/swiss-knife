...
class Method extends \EasyCI20220120\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $flags = 0;
    /** @var array|null */
    ...
    public function addStmt($stmt)
    {
        ...
        $this->stmts[] = \EasyCI20220120\PhpParser\BuilderHelpers::normalizeStmt($stmt);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220120\PhpParser\Node\Stmt\ClassMethod($this->name, ['flags' => $this->flags, 'byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts, 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
