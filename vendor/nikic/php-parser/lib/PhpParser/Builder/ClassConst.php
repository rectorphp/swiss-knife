...
use EasyCI20220403\PhpParser\Node\Const_;
use EasyCI20220403\PhpParser\Node\Identifier;
use EasyCI20220403\PhpParser\Node\Stmt;
class ClassConst implements \EasyCI20220403\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \EasyCI20220403\PhpParser\Node\Const_($name, \EasyCI20220403\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \EasyCI20220403\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
