...
use EasyCI20220325\PhpParser\Node\Const_;
use EasyCI20220325\PhpParser\Node\Identifier;
use EasyCI20220325\PhpParser\Node\Stmt;
class ClassConst implements \EasyCI20220325\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \EasyCI20220325\PhpParser\Node\Const_($name, \EasyCI20220325\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \EasyCI20220325\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
