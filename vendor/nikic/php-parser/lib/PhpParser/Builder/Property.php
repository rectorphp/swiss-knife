...
class Property implements \EasyCI20220125\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \EasyCI20220125\PhpParser\BuilderHelpers::addModifier($this->flags, \EasyCI20220125\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
        return $this;
    }
    /**
    ...
    {
        $this->flags = \EasyCI20220125\PhpParser\BuilderHelpers::addModifier($this->flags, \EasyCI20220125\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY);
        return $this;
    }
    /**
    ...
    {
        $this->default = \EasyCI20220125\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \EasyCI20220125\PhpParser\BuilderHelpers::normalizeType($type);
        return $this;
    }
    /**
    ...
    {
        return new \EasyCI20220125\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \EasyCI20220125\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \EasyCI20220125\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type, $this->attributeGroups);
    }
}
