...
class Namespace_ extends \EasyCI20220316\PhpParser\Builder\Declaration
{
    private $name;
    private $stmts = [];
    /**
    ...
    {
        $this->name = null !== $name ? \EasyCI20220316\PhpParser\BuilderHelpers::normalizeName($name) : null;
    }
    /**
     * Adds a statement.
     *
    ...
    {
        return new \EasyCI20220316\PhpParser\Node\Stmt\Namespace_($this->name, $this->stmts, $this->attributes);
    }
}
