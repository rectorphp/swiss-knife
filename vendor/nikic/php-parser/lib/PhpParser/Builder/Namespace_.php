...
class Namespace_ extends \EasyCI20220225\PhpParser\Builder\Declaration
{
    private $name;
    private $stmts = [];
    /**
    ...
    {
        $this->name = null !== $name ? \EasyCI20220225\PhpParser\BuilderHelpers::normalizeName($name) : null;
    }
    /**
     * Adds a statement.
     *
    ...
    {
        return new \EasyCI20220225\PhpParser\Node\Stmt\Namespace_($this->name, $this->stmts, $this->attributes);
    }
}
