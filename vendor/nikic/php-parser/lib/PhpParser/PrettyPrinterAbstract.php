...
use SwissKnife202412\PhpParser\Internal\DiffElem;
use SwissKnife202412\PhpParser\Internal\Differ;
use SwissKnife202412\PhpParser\Internal\PrintableNewAnonClassNode;
use SwissKnife202412\PhpParser\Internal\TokenStream;
use SwissKnife202412\PhpParser\Node\AttributeGroup;
use SwissKnife202412\PhpParser\Node\Expr;
use SwissKnife202412\PhpParser\Node\Expr\AssignOp;
use SwissKnife202412\PhpParser\Node\Expr\BinaryOp;
use SwissKnife202412\PhpParser\Node\Expr\Cast;
use SwissKnife202412\PhpParser\Node\IntersectionType;
...
use SwissKnife202412\PhpParser\Node\Scalar;
use SwissKnife202412\PhpParser\Node\Stmt;
use SwissKnife202412\PhpParser\Node\UnionType;
