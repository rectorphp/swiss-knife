...
use EasyCI20220313\PhpParser\Internal\DiffElem;
use EasyCI20220313\PhpParser\Internal\PrintableNewAnonClassNode;
use EasyCI20220313\PhpParser\Internal\TokenStream;
...
abstract class PrettyPrinterAbstract
{
    ...
    protected $precedenceMap = [
        ...
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Pow::class => [0, 1],
        \EasyCI20220313\PhpParser\Node\Expr\BitwiseNot::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\PreInc::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\PreDec::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\PostInc::class => [10, -1],
        \EasyCI20220313\PhpParser\Node\Expr\PostDec::class => [10, -1],
        \EasyCI20220313\PhpParser\Node\Expr\UnaryPlus::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\UnaryMinus::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Int_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Double::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\String_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Array_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Object_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Bool_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Cast\Unset_::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\ErrorSuppress::class => [10, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Instanceof_::class => [20, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BooleanNot::class => [30, 1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Mul::class => [40, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Div::class => [40, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Mod::class => [40, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Plus::class => [50, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Minus::class => [50, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Concat::class => [50, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class => [60, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\ShiftRight::class => [60, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Smaller::class => [70, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class => [70, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Greater::class => [70, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class => [70, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Equal::class => [80, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\NotEqual::class => [80, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Identical::class => [80, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\NotIdentical::class => [80, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Spaceship::class => [80, 0],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class => [90, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class => [100, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class => [110, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class => [120, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BooleanOr::class => [130, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Coalesce::class => [140, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Ternary::class => [150, 0],
        // parser uses %left for assignments, but they really behave as %right
        \EasyCI20220313\PhpParser\Node\Expr\Assign::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignRef::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Plus::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Minus::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Mul::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Div::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Concat::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Mod::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseOr::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseXor::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\ShiftLeft::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\ShiftRight::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Pow::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Coalesce::class => [160, 1],
        \EasyCI20220313\PhpParser\Node\Expr\YieldFrom::class => [165, 1],
        \EasyCI20220313\PhpParser\Node\Expr\Print_::class => [168, 1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class => [170, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalXor::class => [180, -1],
        \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalOr::class => [190, -1],
        \EasyCI20220313\PhpParser\Node\Expr\Include_::class => [200, -1],
    ];
     ...
     */
    public function prettyPrintExpr(\EasyCI20220313\PhpParser\Node\Expr $node) : string
    {
        $this->resetState();
    ...
    public function prettyPrintFile(array $stmts) : string
    {
        ...
        if ($stmts[0] instanceof \EasyCI20220313\PhpParser\Node\Stmt\InlineHTML) {
            $p = \preg_replace('/^<\\?php\\s+\\?>\\n?/', '', $p);
        }
        if ($stmts[\count($stmts) - 1] instanceof \EasyCI20220313\PhpParser\Node\Stmt\InlineHTML) {
    ...
    protected function preprocessNodes(array $nodes)
    {
        ...
        foreach ($nodes as $node) {
            if ($node instanceof \EasyCI20220313\PhpParser\Node\Stmt\Namespace_ && null === $node->name) {
    ...
    protected function pStmts(array $nodes, bool $indent = \true) : string
    {
        ...
        foreach ($nodes as $node) {
            ...
            if ($comments) {
                ...
                if ($node instanceof \EasyCI20220313\PhpParser\Node\Stmt\Nop) {
                    continue;
                }
            }
     ...
     */
    protected function pInfixOp(string $class, \EasyCI20220313\PhpParser\Node $leftNode, string $operatorString, \EasyCI20220313\PhpParser\Node $rightNode) : string
    {
     ...
     */
    protected function pPrefixOp(string $class, string $operatorString, \EasyCI20220313\PhpParser\Node $node) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPostfixOp(string $class, \EasyCI20220313\PhpParser\Node $node, string $operatorString) : string
    {
        list($precedence, $associativity) = $this->precedenceMap[$class];
     ...
     */
    protected function pPrec(\EasyCI20220313\PhpParser\Node $node, int $parentPrecedence, int $parentAssociativity, int $childPosition) : string
    {
    ...
    public function printFormatPreserving(array $stmts, array $origStmts, array $origTokens) : string
    {
        ...
        $this->resetState();
        $this->origTokens = new \EasyCI20220313\PhpParser\Internal\TokenStream($origTokens);
        $this->preprocessNodes($stmts);
        $pos = 0;
    ...
    protected function pFallback(\EasyCI20220313\PhpParser\Node $node)
    {
     ...
     * @return string Pretty printed node
     */
    protected function p(\EasyCI20220313\PhpParser\Node $node, $parentFormatPreserved = \false) : string
    {
        ...
        $fallbackNode = $node;
        if ($node instanceof \EasyCI20220313\PhpParser\Node\Expr\New_ && $node->class instanceof \EasyCI20220313\PhpParser\Node\Stmt\Class_) {
            // Normalize node structure of anonymous classes
            $node = \EasyCI20220313\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($node);
            $origNode = \EasyCI20220313\PhpParser\Internal\PrintableNewAnonClassNode::fromNewNode($origNode);
        }
        ...
        // printed.
        if ($node instanceof \EasyCI20220313\PhpParser\Node\Stmt\InlineHTML && !$parentFormatPreserved) {
        ...
        foreach ($node->getSubNodeNames() as $subNodeName) {
            ...
            if (!$subNode instanceof \EasyCI20220313\PhpParser\Node && $subNode !== null || !$origSubNode instanceof \EasyCI20220313\PhpParser\Node && $origSubNode !== null) {
    ...
    protected function pArray(array $nodes, array $origNodes, int &$pos, int $indentAdjustment, string $parentNodeType, string $subNodeName, $fixup)
    {
        ...
        foreach ($diff as $i => $diffElem) {
            ...
            if ($diffType === \EasyCI20220313\PhpParser\Internal\DiffElem::TYPE_KEEP || $diffType === \EasyCI20220313\PhpParser\Internal\DiffElem::TYPE_REPLACE) {
                ...
                if (!$arrItem instanceof \EasyCI20220313\PhpParser\Node || !$origArrItem instanceof \EasyCI20220313\PhpParser\Node) {
                ...
                $skipRemovedNode = \false;
            } elseif ($diffType === \EasyCI20220313\PhpParser\Internal\DiffElem::TYPE_ADD) {
                if (null === $insertStr) {
            ...
            } elseif ($diffType === \EasyCI20220313\PhpParser\Internal\DiffElem::TYPE_REMOVE) {
                if (!$origArrItem instanceof \EasyCI20220313\PhpParser\Node) {
     ...
     */
    protected function pFixup(int $fixup, \EasyCI20220313\PhpParser\Node $subNode, $parentClass, int $subStartPos, int $subEndPos) : string
    {
        switch ($fixup) {
            ...
            case self::FIXUP_VAR_BRACED_NAME:
                if ($subNode instanceof \EasyCI20220313\PhpParser\Node\Expr && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return ($fixup === self::FIXUP_VAR_BRACED_NAME ? '$' : '') . '{' . $this->p($subNode) . '}';
                }
                break;
            case self::FIXUP_ENCAPSED:
                if (!$subNode instanceof \EasyCI20220313\PhpParser\Node\Scalar\EncapsedStringPart && !$this->origTokens->haveBraces($subStartPos, $subEndPos)) {
                    return '{' . $this->p($subNode) . '}';
                }
                break;
            default:
     ...
     */
    protected function callLhsRequiresParens(\EasyCI20220313\PhpParser\Node $node) : bool
    {
     ...
     * @return bool Whether parentheses are required
     */
    protected function dereferenceLhsRequiresParens(\EasyCI20220313\PhpParser\Node $node) : bool
    {
    ...
    {
        return ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC ? 'public ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_PROTECTED ? 'protected ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_PRIVATE ? 'private ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC ? 'static ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT ? 'abstract ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL ? 'final ' : '') . ($modifiers & \EasyCI20220313\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY ? 'readonly ' : '');
    }
    /**
    ...
    protected function initializeNodeListDiffer()
    {
        ...
        $this->nodeListDiffer = new \EasyCI20220313\PhpParser\Internal\Differ(function ($a, $b) {
            if ($a instanceof \EasyCI20220313\PhpParser\Node && $b instanceof \EasyCI20220313\PhpParser\Node) {
    ...
    protected function initializeFixupMap()
    {
        ...
        $this->fixupMap = [
            \EasyCI20220313\PhpParser\Node\Expr\PreInc::class => ['var' => self::FIXUP_PREC_RIGHT],
            \EasyCI20220313\PhpParser\Node\Expr\PreDec::class => ['var' => self::FIXUP_PREC_RIGHT],
            \EasyCI20220313\PhpParser\Node\Expr\PostInc::class => ['var' => self::FIXUP_PREC_LEFT],
            \EasyCI20220313\PhpParser\Node\Expr\PostDec::class => ['var' => self::FIXUP_PREC_LEFT],
            \EasyCI20220313\PhpParser\Node\Expr\Instanceof_::class => ['expr' => self::FIXUP_PREC_LEFT, 'class' => self::FIXUP_PREC_RIGHT],
            \EasyCI20220313\PhpParser\Node\Expr\Ternary::class => ['cond' => self::FIXUP_PREC_LEFT, 'else' => self::FIXUP_PREC_RIGHT],
            \EasyCI20220313\PhpParser\Node\Expr\FuncCall::class => ['name' => self::FIXUP_CALL_LHS],
            \EasyCI20220313\PhpParser\Node\Expr\StaticCall::class => ['class' => self::FIXUP_DEREF_LHS],
            \EasyCI20220313\PhpParser\Node\Expr\ArrayDimFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \EasyCI20220313\PhpParser\Node\Expr\ClassConstFetch::class => ['var' => self::FIXUP_DEREF_LHS],
            \EasyCI20220313\PhpParser\Node\Expr\New_::class => ['class' => self::FIXUP_DEREF_LHS],
            // TODO: FIXUP_NEW_VARIABLE
            \EasyCI20220313\PhpParser\Node\Expr\MethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \EasyCI20220313\PhpParser\Node\Expr\NullsafeMethodCall::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \EasyCI20220313\PhpParser\Node\Expr\StaticPropertyFetch::class => ['class' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_VAR_BRACED_NAME],
            \EasyCI20220313\PhpParser\Node\Expr\PropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \EasyCI20220313\PhpParser\Node\Expr\NullsafePropertyFetch::class => ['var' => self::FIXUP_DEREF_LHS, 'name' => self::FIXUP_BRACED_NAME],
            \EasyCI20220313\PhpParser\Node\Scalar\Encapsed::class => ['parts' => self::FIXUP_ENCAPSED],
        ];
        $binaryOps = [\EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Pow::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Mul::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Div::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Mod::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Plus::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Minus::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Concat::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\ShiftRight::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Smaller::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Greater::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Equal::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\NotEqual::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Identical::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\NotIdentical::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Spaceship::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\BooleanOr::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\Coalesce::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalXor::class, \EasyCI20220313\PhpParser\Node\Expr\BinaryOp\LogicalOr::class];
        foreach ($binaryOps as $binaryOp) {
            $this->fixupMap[$binaryOp] = ['left' => self::FIXUP_PREC_LEFT, 'right' => self::FIXUP_PREC_RIGHT];
        }
        $assignOps = [\EasyCI20220313\PhpParser\Node\Expr\Assign::class, \EasyCI20220313\PhpParser\Node\Expr\AssignRef::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Plus::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Minus::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Mul::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Div::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Concat::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Mod::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseOr::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\BitwiseXor::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\ShiftLeft::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\ShiftRight::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Pow::class, \EasyCI20220313\PhpParser\Node\Expr\AssignOp\Coalesce::class];
        foreach ($assignOps as $assignOp) {
            $this->fixupMap[$assignOp] = ['var' => self::FIXUP_PREC_LEFT, 'expr' => self::FIXUP_PREC_RIGHT];
        }
        $prefixOps = [\EasyCI20220313\PhpParser\Node\Expr\BitwiseNot::class, \EasyCI20220313\PhpParser\Node\Expr\BooleanNot::class, \EasyCI20220313\PhpParser\Node\Expr\UnaryPlus::class, \EasyCI20220313\PhpParser\Node\Expr\UnaryMinus::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Int_::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Double::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\String_::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Array_::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Object_::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Bool_::class, \EasyCI20220313\PhpParser\Node\Expr\Cast\Unset_::class, \EasyCI20220313\PhpParser\Node\Expr\ErrorSuppress::class, \EasyCI20220313\PhpParser\Node\Expr\YieldFrom::class, \EasyCI20220313\PhpParser\Node\Expr\Print_::class, \EasyCI20220313\PhpParser\Node\Expr\Include_::class];
