...
use EasyCI20220613\PhpParser\Node\ComplexType;
use EasyCI20220613\PhpParser\Node\Expr;
use EasyCI20220613\PhpParser\Node\Identifier;
use EasyCI20220613\PhpParser\Node\Name;
use EasyCI20220613\PhpParser\Node\NullableType;
use EasyCI20220613\PhpParser\Node\Scalar;
...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('EasyCI20220613\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('EasyCI20220613\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    public static function normalizeName($name) : Name
    {
        ...
        throw new \LogicException('EasyCI20220613\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeNameOrExpr($name)
    {
        ...
        if (!\is_string($name) && !$name instanceof Name) {
            throw new \LogicException('EasyCI20220613\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
    ...
    public static function normalizeDocComment($docComment) : Comment\Doc
    {
        ...
        throw new \LogicException('EasyCI20220613\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
    }
    /**
    ...
    public static function normalizeAttribute($attribute) : Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof Node\Attribute) {
            throw new \LogicException('EasyCI20220613\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
