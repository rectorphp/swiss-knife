...
namespace SwissKnife202412\PhpParser\Lexer;

use SwissKnife202412\PhpParser\Error;
use SwissKnife202412\PhpParser\ErrorHandler;
use SwissKnife202412\PhpParser\Lexer;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use SwissKnife202412\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use SwissKnife202412\PhpParser\PhpVersion;
use SwissKnife202412\PhpParser\Token;
