...
class NodeTraverser implements \EasyCI20220530\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    public function addVisitor(\EasyCI20220530\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    public function removeVisitor(\EasyCI20220530\PhpParser\NodeVisitor $visitor)
    {
     ...
     */
    protected function traverseNode(\EasyCI20220530\PhpParser\Node $node) : \EasyCI20220530\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \EasyCI20220530\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \EasyCI20220530\PhpParser\Node) {
    ...
    {
        if ($old instanceof \EasyCI20220530\PhpParser\Node\Stmt && $new instanceof \EasyCI20220530\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \EasyCI20220530\PhpParser\Node\Expr && $new instanceof \EasyCI20220530\PhpParser\Node\Stmt) {
