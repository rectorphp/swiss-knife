...
use EasyCI20220612\PhpParser\Parser\Tokens;
class Lexer
{
    protected $code;
    protected $tokens;
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('EasyCI20220612\\T_ONUMBER')) {
            $tokenMap[\EasyCI20220612\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('EasyCI20220612\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\EasyCI20220612\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
