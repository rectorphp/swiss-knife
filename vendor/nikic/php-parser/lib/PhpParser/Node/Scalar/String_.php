...
class String_ extends \EasyCI20220604\PhpParser\Node\Scalar
{
    ...
    {
        $attributes['kind'] = $str[0] === "'" || $str[1] === "'" && ($str[0] === 'b' || $str[0] === 'B') ? \EasyCI20220604\PhpParser\Node\Scalar\String_::KIND_SINGLE_QUOTED : \EasyCI20220604\PhpParser\Node\Scalar\String_::KIND_DOUBLE_QUOTED;
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \EasyCI20220604\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
