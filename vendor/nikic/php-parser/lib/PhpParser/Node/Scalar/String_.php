...
class String_ extends \EasyCI20220305\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \EasyCI20220305\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
