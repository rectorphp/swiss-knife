...
class NullsafePropertyFetch extends \EasyCI20220211\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\EasyCI20220211\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
