...
class NullsafePropertyFetch extends \EasyCI20220115\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\EasyCI20220115\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
