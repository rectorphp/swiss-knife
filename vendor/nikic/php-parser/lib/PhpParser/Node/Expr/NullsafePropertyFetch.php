...
class NullsafePropertyFetch extends \EasyCI20220501\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\EasyCI20220501\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
