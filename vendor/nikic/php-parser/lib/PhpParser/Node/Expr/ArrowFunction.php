...
class ArrowFunction extends \EasyCI20220131\PhpParser\Node\Expr implements \EasyCI20220131\PhpParser\Node\FunctionLike
{
    /** @var bool */
    public $static;
    /** @var bool */
    ...
    {
        return [new \EasyCI20220131\PhpParser\Node\Stmt\Return_($this->expr)];
    }
