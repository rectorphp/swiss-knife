...
class NullsafeMethodCall extends \EasyCI20220211\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\EasyCI20220211\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
