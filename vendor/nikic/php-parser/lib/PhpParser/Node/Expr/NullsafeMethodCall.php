...
class NullsafeMethodCall extends \EasyCI20220115\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\EasyCI20220115\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
