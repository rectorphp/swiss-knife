...
namespace SwissKnife202501\PhpParser\Node;

use SwissKnife202501\PhpParser\Modifiers;
use SwissKnife202501\PhpParser\Node\Expr\Assign;
use SwissKnife202501\PhpParser\Node\Expr\PropertyFetch;
use SwissKnife202501\PhpParser\Node\Expr\Variable;
use SwissKnife202501\PhpParser\Node\Stmt\Expression;
use SwissKnife202501\PhpParser\Node\Stmt\Return_;
use SwissKnife202501\PhpParser\NodeAbstract;
