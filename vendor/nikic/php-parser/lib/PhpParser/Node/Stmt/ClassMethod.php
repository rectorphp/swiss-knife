...
use EasyCI20220130\PhpParser\Node\FunctionLike;
class ClassMethod extends \EasyCI20220130\PhpParser\Node\Stmt implements \EasyCI20220130\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \EasyCI20220130\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \EasyCI20220130\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
    ...
    {
        return (bool) ($this->flags & \EasyCI20220130\PhpParser\Node\Stmt\Class_::MODIFIER_FINAL);
    }
    /**
