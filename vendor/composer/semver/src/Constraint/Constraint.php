 ...
 */
namespace EasyCI20220524\Composer\Semver\Constraint;

/**
 * Defines a constraint.
 */
class Constraint implements \EasyCI20220524\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matches(\EasyCI20220524\Composer\Semver\Constraint\ConstraintInterface $provider)
    {
     ...
     * @return bool
     */
    public function matchSpecific(\EasyCI20220524\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
    ...
    private function extractBounds()
    {
        ...
        // Branches
        if (\strpos($this->version, 'dev-') === 0) {
            $this->lowerBound = \EasyCI20220524\Composer\Semver\Constraint\Bound::zero();
            $this->upperBound = \EasyCI20220524\Composer\Semver\Constraint\Bound::positiveInfinity();
            return;
        }
        switch ($this->operator) {
            case self::OP_EQ:
                $this->lowerBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                $this->upperBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_LT:
                $this->lowerBound = \EasyCI20220524\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \false);
                break;
            case self::OP_LE:
                $this->lowerBound = \EasyCI20220524\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_GT:
                $this->lowerBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \false);
                $this->upperBound = \EasyCI20220524\Composer\Semver\Constraint\Bound::positiveInfinity();
                break;
            case self::OP_GE:
                $this->lowerBound = new \EasyCI20220524\Composer\Semver\Constraint\Bound($this->version, \true);
