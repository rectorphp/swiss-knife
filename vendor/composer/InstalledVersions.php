 ...
 */
namespace EasyCI20220607\Composer;
...
class InstalledVersions
{
     ...
     * @return bool
     */
    public static function satisfies(\EasyCI20220607\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('EasyCI20220607\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\EasyCI20220607\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
