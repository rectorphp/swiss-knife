...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\EasyCI20220525\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\EasyCI20220525\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \EasyCI20220525\Symplify\SmartFileSystem\SmartFileInfo) {
