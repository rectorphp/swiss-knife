...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\EasyCI20220306\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\EasyCI20220306\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \EasyCI20220306\Symplify\SmartFileSystem\SmartFileInfo) {
