...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\EasyCI20220604\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\EasyCI20220604\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \EasyCI20220604\Symplify\SmartFileSystem\SmartFileInfo) {
