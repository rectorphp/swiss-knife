...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\EasyCI20220416\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\EasyCI20220416\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \EasyCI20220416\Symplify\SmartFileSystem\SmartFileInfo) {
