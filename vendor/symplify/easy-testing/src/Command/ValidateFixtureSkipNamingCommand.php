...
namespace EasyCI20220206\Symplify\EasyTesting\Command;
...
use EasyCI20220206\Symplify\EasyTesting\Finder\FixtureFinder;
use EasyCI20220206\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use EasyCI20220206\Symplify\EasyTesting\ValueObject\Option;
use EasyCI20220206\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \EasyCI20220206\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220206\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \EasyCI20220206\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220206\Symplify\EasyTesting\ValueObject\Option::SOURCE, \EasyCI20220206\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220206\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\EasyCI20220206\Symplify\EasyTesting\ValueObject\Option::SOURCE);
