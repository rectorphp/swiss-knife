...
namespace EasyCI20220602\Symplify\EasyTesting\Command;
...
use EasyCI20220602\Symplify\EasyTesting\Finder\FixtureFinder;
use EasyCI20220602\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use EasyCI20220602\Symplify\EasyTesting\ValueObject\Option;
use EasyCI20220602\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \EasyCI20220602\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220602\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \EasyCI20220602\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220602\Symplify\EasyTesting\ValueObject\Option::SOURCE, \EasyCI20220602\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220602\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\EasyCI20220602\Symplify\EasyTesting\ValueObject\Option::SOURCE);
