...
namespace EasyCI20220306\Symplify\EasyTesting\Command;
...
use EasyCI20220306\Symplify\EasyTesting\Finder\FixtureFinder;
use EasyCI20220306\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use EasyCI20220306\Symplify\EasyTesting\ValueObject\Option;
use EasyCI20220306\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \EasyCI20220306\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220306\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \EasyCI20220306\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220306\Symplify\EasyTesting\ValueObject\Option::SOURCE, \EasyCI20220306\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220306\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\EasyCI20220306\Symplify\EasyTesting\ValueObject\Option::SOURCE);
