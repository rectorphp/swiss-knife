...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('EasyCI20220221\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/NodeVisitor', __DIR__ . '/../src/PhpParser/SmartPhpParser.php', __DIR__ . '/../src/PhpDocParser/PhpDocNodeVisitor/CallablePhpDocNodeVisitor.php']);
    ...
    // phpdoc parser
    $services->set(\EasyCI20220221\PHPStan\PhpDocParser\Parser\PhpDocParser::class);
    $services->set(\EasyCI20220221\PHPStan\PhpDocParser\Lexer\Lexer::class);
    $services->set(\EasyCI20220221\PHPStan\PhpDocParser\Parser\TypeParser::class);
    $services->set(\EasyCI20220221\PHPStan\PhpDocParser\Parser\ConstExprParser::class);
};
