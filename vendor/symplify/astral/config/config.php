...
use EasyCI20220612\PhpParser\NodeFinder;
...
use EasyCI20220612\Symplify\Astral\PhpParser\SmartPhpParser;
use EasyCI20220612\Symplify\Astral\PhpParser\SmartPhpParserFactory;
...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('EasyCI20220612\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/NodeVisitor', __DIR__ . '/../src/PhpParser/SmartPhpParser.php', __DIR__ . '/../src/PhpDocParser/PhpDocNodeVisitor/CallablePhpDocNodeVisitor.php']);
