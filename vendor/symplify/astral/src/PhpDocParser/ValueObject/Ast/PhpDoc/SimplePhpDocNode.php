 ...
 */
class SimplePhpDocNode extends \EasyCI20220607\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode
{
    public function getParam(string $desiredParamName) : ?\EasyCI20220607\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
    ...
    public function getParamType(string $desiredParamName) : ?\EasyCI20220607\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $paramTagValueNode = $this->getParam($desiredParamName);
        if (!$paramTagValueNode instanceof \EasyCI20220607\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode) {
            return null;
        }
