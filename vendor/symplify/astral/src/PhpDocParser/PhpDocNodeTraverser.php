...
use EasyCI202206\Symplify\Astral\PhpDocParser\Exception\InvalidTraverseException;
use EasyCI202206\Symplify\Astral\PhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor;
/**
 * @api
 *
 * Mimics
