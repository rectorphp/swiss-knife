 ...
 */
abstract class AbstractPhpDocNodeVisitor implements \EasyCI20220403\Symplify\Astral\PhpDocParser\Contract\PhpDocNodeVisitorInterface
{
     ...
     */
    public function enterNode(\EasyCI20220403\PHPStan\PhpDocParser\Ast\Node $node)
    {
        return null;
    }
    /**
    ...
    public function afterTraverse(\EasyCI20220403\PHPStan\PhpDocParser\Ast\Node $node) : void
    {
    }
}
