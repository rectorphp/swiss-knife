 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \EasyCI20220512\Symplify\Astral\PhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\EasyCI20220512\PHPStan\PhpDocParser\Ast\Node $node) : \EasyCI20220512\PHPStan\PhpDocParser\Ast\Node
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\EasyCI20220512\Symplify\Astral\PhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
