...
final class FuncCallNodeNameResolver implements \EasyCI20220216\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220216\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220216\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
