...
use EasyCI20220302\PhpParser\Node\Attribute;
use EasyCI20220302\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \EasyCI20220302\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220302\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220302\PhpParser\Node\Attribute;
    }
    /**
