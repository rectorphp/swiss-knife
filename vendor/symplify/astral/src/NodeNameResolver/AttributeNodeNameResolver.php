...
use EasyCI20220308\PhpParser\Node\Attribute;
use EasyCI20220308\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \EasyCI20220308\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220308\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220308\PhpParser\Node\Attribute;
    }
    /**
