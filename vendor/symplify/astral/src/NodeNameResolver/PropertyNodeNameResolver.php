...
final class PropertyNodeNameResolver implements \EasyCI20220503\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220503\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220503\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
