...
final class PropertyNodeNameResolver implements \EasyCI20220216\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220216\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220216\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
