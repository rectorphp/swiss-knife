...
final class PropertyNodeNameResolver implements \EasyCI20220316\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220316\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220316\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
