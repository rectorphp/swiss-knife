...
final class PropertyNodeNameResolver implements \EasyCI20220227\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220227\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220227\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
