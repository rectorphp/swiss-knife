...
final class PropertyNodeNameResolver implements \EasyCI20220514\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220514\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220514\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
