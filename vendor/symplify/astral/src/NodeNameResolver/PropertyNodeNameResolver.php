...
final class PropertyNodeNameResolver implements \EasyCI20220219\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220219\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220219\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
