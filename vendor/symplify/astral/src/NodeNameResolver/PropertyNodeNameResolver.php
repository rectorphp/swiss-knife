...
final class PropertyNodeNameResolver implements \EasyCI20220204\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220204\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220204\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
