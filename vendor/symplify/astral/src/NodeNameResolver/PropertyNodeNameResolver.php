...
final class PropertyNodeNameResolver implements \EasyCI20220202\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220202\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220202\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
