...
final class PropertyNodeNameResolver implements \EasyCI20220531\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220531\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220531\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
