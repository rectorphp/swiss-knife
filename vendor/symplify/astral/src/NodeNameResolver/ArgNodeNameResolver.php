...
final class ArgNodeNameResolver implements \EasyCI20220223\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220223\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220223\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
