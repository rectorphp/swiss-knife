...
final class ArgNodeNameResolver implements \EasyCI20220126\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220126\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220126\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
