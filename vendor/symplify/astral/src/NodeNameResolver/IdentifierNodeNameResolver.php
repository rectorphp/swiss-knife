...
final class IdentifierNodeNameResolver implements \EasyCI20220216\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220216\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220216\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220216\PhpParser\Node\Name;
    }
    /**
