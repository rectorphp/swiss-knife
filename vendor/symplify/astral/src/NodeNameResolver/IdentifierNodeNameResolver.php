...
final class IdentifierNodeNameResolver implements \EasyCI20220211\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220211\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220211\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220211\PhpParser\Node\Name;
    }
    /**
