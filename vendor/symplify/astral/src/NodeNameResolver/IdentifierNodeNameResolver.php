...
final class IdentifierNodeNameResolver implements \EasyCI20220124\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220124\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220124\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220124\PhpParser\Node\Name;
    }
    /**
