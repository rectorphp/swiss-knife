...
final class IdentifierNodeNameResolver implements \EasyCI20220308\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220308\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220308\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220308\PhpParser\Node\Name;
    }
    /**
