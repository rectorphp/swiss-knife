...
final class IdentifierNodeNameResolver implements \EasyCI20220207\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220207\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220207\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220207\PhpParser\Node\Name;
    }
    /**
