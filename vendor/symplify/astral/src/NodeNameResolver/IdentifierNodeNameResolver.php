...
final class IdentifierNodeNameResolver implements \EasyCI20220525\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220525\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220525\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220525\PhpParser\Node\Name;
    }
    /**
