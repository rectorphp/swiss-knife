...
final class IdentifierNodeNameResolver implements \EasyCI20220529\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220529\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220529\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220529\PhpParser\Node\Name;
    }
    /**
