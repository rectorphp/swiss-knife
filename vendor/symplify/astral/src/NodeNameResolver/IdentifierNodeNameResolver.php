...
final class IdentifierNodeNameResolver implements \EasyCI20220130\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220130\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220130\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220130\PhpParser\Node\Name;
    }
    /**
