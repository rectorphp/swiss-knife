...
final class IdentifierNodeNameResolver implements \EasyCI20220429\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220429\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220429\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220429\PhpParser\Node\Name;
    }
    /**
