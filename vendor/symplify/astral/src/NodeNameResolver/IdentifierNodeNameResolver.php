...
final class IdentifierNodeNameResolver implements \EasyCI20220218\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220218\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220218\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220218\PhpParser\Node\Name;
    }
    /**
