...
final class IdentifierNodeNameResolver implements \EasyCI20220116\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220116\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220116\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220116\PhpParser\Node\Name;
    }
    /**
