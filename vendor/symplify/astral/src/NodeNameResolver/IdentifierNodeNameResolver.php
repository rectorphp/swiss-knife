...
final class IdentifierNodeNameResolver implements \EasyCI20220315\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220315\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220315\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220315\PhpParser\Node\Name;
    }
    /**
