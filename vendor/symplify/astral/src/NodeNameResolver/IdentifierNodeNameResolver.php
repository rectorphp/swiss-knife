...
final class IdentifierNodeNameResolver implements \EasyCI20220605\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220605\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220605\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220605\PhpParser\Node\Name;
    }
    /**
