...
final class IdentifierNodeNameResolver implements \EasyCI20220509\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220509\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220509\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220509\PhpParser\Node\Name;
    }
    /**
