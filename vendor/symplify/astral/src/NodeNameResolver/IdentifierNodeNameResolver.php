...
final class IdentifierNodeNameResolver implements \EasyCI20220403\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220403\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220403\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220403\PhpParser\Node\Name;
    }
    /**
