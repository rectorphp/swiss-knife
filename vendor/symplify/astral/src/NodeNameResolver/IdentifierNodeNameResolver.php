...
final class IdentifierNodeNameResolver implements \EasyCI20220415\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220415\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220415\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220415\PhpParser\Node\Name;
    }
    /**
