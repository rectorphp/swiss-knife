...
final class IdentifierNodeNameResolver implements \EasyCI20220202\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220202\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220202\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220202\PhpParser\Node\Name;
    }
    /**
