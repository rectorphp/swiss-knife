...
final class IdentifierNodeNameResolver implements \EasyCI20220303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220303\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220303\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220303\PhpParser\Node\Name;
    }
    /**
