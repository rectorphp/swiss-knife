...
final class IdentifierNodeNameResolver implements \EasyCI20220503\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220503\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220503\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220503\PhpParser\Node\Name;
    }
    /**
