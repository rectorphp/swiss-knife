...
final class IdentifierNodeNameResolver implements \EasyCI20220120\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220120\PhpParser\Node $node) : bool
    {
        if ($node instanceof \EasyCI20220120\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \EasyCI20220120\PhpParser\Node\Name;
    }
    /**
