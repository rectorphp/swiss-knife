...
final class ParamNodeNameResolver implements \EasyCI20220120\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\EasyCI20220120\PhpParser\Node $node) : bool
    {
        return $node instanceof \EasyCI20220120\PhpParser\Node\Param;
    }
    /**
     * @param Param $node
     */
    public function resolve(\EasyCI20220120\PhpParser\Node $node) : ?string
    {
        ...
        if ($paramName instanceof \EasyCI20220120\PhpParser\Node\Expr) {
            return null;
        }
        return $paramName;
    }
