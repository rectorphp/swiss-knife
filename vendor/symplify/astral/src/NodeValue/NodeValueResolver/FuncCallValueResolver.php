...
use EasyCI20220215\PhpParser\Node\Expr\FuncCall;
 ...
 */
final class FuncCallValueResolver implements \EasyCI20220215\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\EasyCI20220215\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \EasyCI20220215\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \EasyCI20220215\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
     * @param FuncCall $expr
     * @return mixed
    ...
    public function resolve(\EasyCI20220215\PhpParser\Node\Expr $expr, string $currentFilePath)
    {
        ...
        if ($expr->name instanceof \EasyCI20220215\PhpParser\Node\Name) {
