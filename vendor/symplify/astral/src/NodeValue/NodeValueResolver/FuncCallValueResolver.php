 ...
 */
final class FuncCallValueResolver implements \EasyCI20220306\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\EasyCI20220306\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \EasyCI20220306\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \EasyCI20220306\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
     * @param FuncCall $expr
     * @return mixed
    ...
    public function resolve(\EasyCI20220306\PhpParser\Node\Expr $expr, string $currentFilePath)
    {
        ...
        if ($expr->name instanceof \EasyCI20220306\PhpParser\Node\Name) {
