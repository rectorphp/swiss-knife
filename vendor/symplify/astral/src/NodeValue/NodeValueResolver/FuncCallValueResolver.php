 ...
 */
final class FuncCallValueResolver implements \EasyCI20220313\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\EasyCI20220313\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \EasyCI20220313\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \EasyCI20220313\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
     * @param FuncCall $expr
     * @return mixed
    ...
    public function resolve(\EasyCI20220313\PhpParser\Node\Expr $expr, string $currentFilePath)
    {
        ...
        if ($expr->name instanceof \EasyCI20220313\PhpParser\Node\Name) {
