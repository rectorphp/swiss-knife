...
use EasyCI20220529\PhpParser\Node\Expr\FuncCall;
 ...
 */
final class FuncCallValueResolver implements \EasyCI20220529\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(\EasyCI20220529\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \EasyCI20220529\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \EasyCI20220529\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
     * @param FuncCall $expr
     * @return mixed
    ...
    public function resolve(\EasyCI20220529\PhpParser\Node\Expr $expr, string $currentFilePath)
    {
        ...
        if ($expr->name instanceof \EasyCI20220529\PhpParser\Node\Name) {
