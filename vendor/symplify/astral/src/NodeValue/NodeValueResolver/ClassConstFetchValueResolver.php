 ...
 */
final class ClassConstFetchValueResolver implements \EasyCI20220211\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\EasyCI20220211\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \EasyCI20220211\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    {
        return \EasyCI20220211\PhpParser\Node\Expr\ClassConstFetch::class;
    }
    /**
    ...
    public function resolve(\EasyCI20220211\PhpParser\Node\Expr $expr, string $currentFilePath)
    {
        ...
        if ($className === 'self') {
            $classLike = $this->simpleNodeFinder->findFirstParentByType($expr, \EasyCI20220211\PhpParser\Node\Stmt\ClassLike::class);
            if (!$classLike instanceof \EasyCI20220211\PhpParser\Node\Stmt\ClassLike) {
                return null;
            }
