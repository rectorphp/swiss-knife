 ...
 */
final class ConstFetchValueResolver implements \EasyCI20220606\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    {
        return \EasyCI20220606\PhpParser\Node\Expr\ConstFetch::class;
    }
    /**
