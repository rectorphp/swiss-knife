 ...
 */
final class ConstFetchValueResolver implements \EasyCI20220607\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    {
        return \EasyCI20220607\PhpParser\Node\Expr\ConstFetch::class;
    }
    /**
