...
namespace EasyCI20220607\Symplify\Astral\NodeAnalyzer;

use EasyCI20220607\Nette\Application\UI\Template;
...
use EasyCI20220607\Symplify\Astral\TypeAnalyzer\ContainsTypeAnalyser;
/**
 * @api
 */
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['EasyCI20220607\\Nette\\Application\\UI\\Template', 'EasyCI20220607\\Nette\\Application\\UI\\ITemplate', 'EasyCI20220607\\Nette\\Bridges\\ApplicationLatte\\Template', 'EasyCI20220607\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'EasyCI20220607\\Nette\\Application\\UI\\Control', \true);
    }
}
