...
namespace EasyCI20220608\Symplify\Astral\NodeAnalyzer;

use EasyCI20220608\Nette\Application\UI\Template;
...
use EasyCI20220608\Symplify\Astral\TypeAnalyzer\ContainsTypeAnalyser;
/**
 * @api
 */
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['EasyCI20220608\\Nette\\Application\\UI\\Template', 'EasyCI20220608\\Nette\\Application\\UI\\ITemplate', 'EasyCI20220608\\Nette\\Bridges\\ApplicationLatte\\Template', 'EasyCI20220608\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideComponentContainer(Scope $scope) : bool
    {
        ...
        // this type has getComponent() method
        return \is_a($className, 'EasyCI20220608\\Nette\\ComponentModel\\Container', \true);
    }
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'EasyCI20220608\\Nette\\Application\\UI\\Control', \true);
    }
}
