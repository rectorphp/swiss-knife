...
namespace EasyCI20220130\Symplify\Astral\NodeFinder;
...
final class SimpleNodeFinder
{
     ...
     */
    public function findFirstByType(\EasyCI20220130\PhpParser\Node $node, string $nodeClass)
    {
     ...
     * @return T[]
     */
    public function findByType(\EasyCI20220130\PhpParser\Node $node, string $nodeClass) : array
    {
     ...
     */
    public function hasByTypes(\EasyCI20220130\PhpParser\Node $node, array $nodeClasses) : bool
    {
