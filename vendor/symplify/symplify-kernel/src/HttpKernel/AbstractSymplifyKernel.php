...
namespace EasyCI202206\Symplify\SymplifyKernel\HttpKernel;
...
use EasyCI202206\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
...
use EasyCI202206\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use EasyCI202206\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use EasyCI202206\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \EasyCI202206\Psr\Container\ContainerInterface
    {
