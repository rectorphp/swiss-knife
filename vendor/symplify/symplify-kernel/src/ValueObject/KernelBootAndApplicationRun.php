...
namespace EasyCI20220115\Symplify\SymplifyKernel\ValueObject;
...
use EasyCI20220115\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use EasyCI20220115\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    public function run() : void
    {
        try {
            ...
            $symfonyStyleFactory = new \EasyCI20220115\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory();
            $symfonyStyle = $symfonyStyleFactory->create();
            $symfonyStyle->error($throwable->getMessage());
            exit(\EasyCI20220115\Symfony\Component\Console\Command\Command::FAILURE);
        }
    }
    /**
    ...
    private function createKernel()
    {
        ...
        return new $kernelClass($environment, \EasyCI20220115\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
    }
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\EasyCI20220115\Symfony\Component\Console\Application::class);
    ...
    {
        if (\is_a($kernelClass, \EasyCI20220115\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            return;
        }
        if (\is_a($kernelClass, \EasyCI20220115\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, \true)) {
            return;
        ...
        $errorMessage = \sprintf('Class "%s" must by type of "%s" or "%s". "%s" given', $kernelClass, \EasyCI20220115\Symfony\Component\HttpKernel\KernelInterface::class, \EasyCI20220115\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, $currentValueType);
        throw new \EasyCI20220115\Symplify\SymplifyKernel\Exception\BootException($errorMessage);
    }
}
