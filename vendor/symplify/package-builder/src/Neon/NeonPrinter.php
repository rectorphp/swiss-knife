...
namespace EasyCI20220307\Symplify\PackageBuilder\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \EasyCI20220307\Nette\Neon\Neon::encode($phpStanNeon, \EasyCI20220307\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \EasyCI20220307\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \EasyCI20220307\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
