...
namespace EasyCI20220225\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\EasyCI20220225\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \EasyCI20220225\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \EasyCI20220225\Symfony\Component\Finder\Finder();
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \EasyCI20220225\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
