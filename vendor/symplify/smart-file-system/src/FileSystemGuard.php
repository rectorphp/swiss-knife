...
final class FileSystemGuard
{
    public function ensureFileExists(string $file, string $location) : void
    {
        ...
        throw new \EasyCI20220517\Symplify\SmartFileSystem\Exception\FileNotFoundException(\sprintf('File "%s" not found in "%s".', $file, $location));
    }
    public function ensureDirectoryExists(string $directory, string $extraMessage) : void
    {
        ...
        throw new \EasyCI20220517\Symplify\SmartFileSystem\Exception\DirectoryNotFoundException($message);
    }
}
