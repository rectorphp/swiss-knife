...
namespace EasyCI20220529\Symplify\VendorPatches\Composer;

use EasyCI20220529\Symplify\Astral\Exception\ShouldNotHappenException;
use EasyCI20220529\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
...
final class ComposerPatchesConfigurationUpdater
{
    ...
    public function __construct(\EasyCI20220529\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \EasyCI20220529\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \EasyCI20220529\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
     ...
     */
    public function updateComposerJson(string $composerJsonFilePath, array $composerExtraPatches) : \EasyCI20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function updateComposerJsonAndPrint(string $composerJsonFilePath, array $composerExtraPatches) : void
    {
        ...
        if (!$fileInfo instanceof \EasyCI20220529\Symplify\SmartFileSystem\SmartFileInfo) {
