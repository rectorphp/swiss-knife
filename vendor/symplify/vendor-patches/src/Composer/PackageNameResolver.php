...
use EasyCI20220527\Symplify\VendorPatches\FileSystem\PathResolver;
/**
...
final class PackageNameResolver
{
    ...
    public function __construct(\EasyCI20220527\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \EasyCI20220527\Symplify\VendorPatches\FileSystem\PathResolver $pathResolver, \EasyCI20220527\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        $this->jsonFileSystem = $jsonFileSystem;
        $this->pathResolver = $pathResolver;
        $this->fileSystemGuard = $fileSystemGuard;
    }
    public function resolveFromFileInfo(\EasyCI20220527\Symplify\SmartFileSystem\SmartFileInfo $vendorFile) : string
    {
    ...
    private function getPackageComposerJsonFilePath(\EasyCI20220527\Symplify\SmartFileSystem\SmartFileInfo $vendorFileInfo) : string
    {
