...
use EasyCI20220529\Symplify\VendorPatches\FileSystem\PathResolver;
/**
...
final class PackageNameResolver
{
    ...
    public function __construct(\EasyCI20220529\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \EasyCI20220529\Symplify\VendorPatches\FileSystem\PathResolver $pathResolver, \EasyCI20220529\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        $this->jsonFileSystem = $jsonFileSystem;
        $this->pathResolver = $pathResolver;
        $this->fileSystemGuard = $fileSystemGuard;
    }
    public function resolveFromFileInfo(\EasyCI20220529\Symplify\SmartFileSystem\SmartFileInfo $vendorFile) : string
    {
    ...
    private function getPackageComposerJsonFilePath(\EasyCI20220529\Symplify\SmartFileSystem\SmartFileInfo $vendorFileInfo) : string
    {
