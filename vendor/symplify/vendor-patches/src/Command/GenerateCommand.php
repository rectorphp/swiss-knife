...
namespace EasyCI20220529\Symplify\VendorPatches\Command;
...
use EasyCI20220529\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use EasyCI20220529\Symplify\PackageBuilder\Console\Command\CommandNaming;
use EasyCI20220529\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use EasyCI20220529\Symplify\VendorPatches\Console\GenerateCommandReporter;
use EasyCI20220529\Symplify\VendorPatches\Differ\PatchDiffer;
use EasyCI20220529\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use EasyCI20220529\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \EasyCI20220529\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220529\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \EasyCI20220529\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \EasyCI20220529\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \EasyCI20220529\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \EasyCI20220529\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \EasyCI20220529\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\EasyCI20220529\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
