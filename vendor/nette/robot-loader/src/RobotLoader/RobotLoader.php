 ...
 */
namespace SwissKnife202605\Nette\Loaders;

use SwissKnife202605\Nette;
...
class RobotLoader
{
    ...
    {
        spl_autoload_register(\Closure::fromCallable([$this, 'tryLoad']), \true, $prepend);
        return $this;
    }
    /**
    ...
    private function generateCacheFileName() : string
    {
        ...
        return $this->tempDirectory . '/' . hash('md5', serialize($this->generateCacheKey())) . '.php';
    }
