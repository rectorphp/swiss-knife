...
use EasyCI20220520\Nette\Neon;
use EasyCI20220520\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \EasyCI20220520\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \EasyCI20220520\Nette\Neon\Entity
    {
        ...
        return new \EasyCI20220520\Nette\Neon\Entity(\EasyCI20220520\Nette\Neon\Neon::Chain, $entities);
    }
