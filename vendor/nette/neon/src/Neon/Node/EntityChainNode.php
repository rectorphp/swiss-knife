...
use EasyCI20220303\Nette\Neon;
use EasyCI20220303\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \EasyCI20220303\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \EasyCI20220303\Nette\Neon\Entity
    {
        ...
        return new \EasyCI20220303\Nette\Neon\Entity(\EasyCI20220303\Nette\Neon\Neon::CHAIN, $entities);
    }
