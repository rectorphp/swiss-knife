...
use EasyCI20220302\Nette\Neon;
use EasyCI20220302\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \EasyCI20220302\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \EasyCI20220302\Nette\Neon\Entity
    {
        ...
        return new \EasyCI20220302\Nette\Neon\Entity(\EasyCI20220302\Nette\Neon\Neon::CHAIN, $entities);
    }
