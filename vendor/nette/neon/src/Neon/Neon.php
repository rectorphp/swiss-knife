...
final class Neon
{
    public const BLOCK = \EasyCI20220415\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \EasyCI20220415\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \EasyCI20220415\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \EasyCI20220415\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
