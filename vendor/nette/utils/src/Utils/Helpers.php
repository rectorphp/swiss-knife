...
class Helpers
{
    ...
    public static function getLastError() : string
    {
        ...
        $message = \ini_get('html_errors') ? \EasyCI20220213\Nette\Utils\Html::htmlToText($message) : $message;
    ...
    {
        if ($min > $max) {
            throw new \EasyCI20220213\Nette\InvalidArgumentException("Minimum ({$min}) is not less than maximum ({$max}).");
        }
