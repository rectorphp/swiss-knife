 ...
 */
namespace EasyCI20220607\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends \EasyCI20220607\PHPUnit\Framework\TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI20220607\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI20220607\Psr\Container\ContainerExceptionInterface::class);
