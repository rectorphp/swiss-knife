 ...
 */
namespace EasyCI20220609\Symfony\Contracts\Service\Test;

use EasyCI20220609\PHPUnit\Framework\TestCase;
use EasyCI20220609\Psr\Container\ContainerInterface;
use EasyCI20220609\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI20220609\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI20220609\Psr\Container\ContainerExceptionInterface::class);
