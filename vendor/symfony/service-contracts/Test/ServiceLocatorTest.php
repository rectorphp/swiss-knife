 ...
 */
namespace EasyCI202210\Symfony\Contracts\Service\Test;

use EasyCI202210\PHPUnit\Framework\TestCase;
use EasyCI202210\Psr\Container\ContainerInterface;
use EasyCI202210\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI202210\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI202210\Psr\Container\ContainerExceptionInterface::class);
