 ...
 */
namespace EasyCI20220610\Symfony\Contracts\Service\Test;

use EasyCI20220610\PHPUnit\Framework\TestCase;
use EasyCI20220610\Psr\Container\ContainerInterface;
use EasyCI20220610\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI20220610\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI20220610\Psr\Container\ContainerExceptionInterface::class);
