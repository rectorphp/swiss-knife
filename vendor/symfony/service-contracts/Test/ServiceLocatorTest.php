 ...
 */
namespace EasyCI202207\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\EasyCI202207\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\EasyCI202207\Psr\Container\ContainerExceptionInterface::class);
