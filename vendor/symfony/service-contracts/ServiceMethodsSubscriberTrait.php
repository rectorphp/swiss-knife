...
use SwissKnife202606\Symfony\Contracts\Service\Attribute\Required;
use SwissKnife202606\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices() : array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (\PHP_VERSION_ID < 80400 || !$reflector->hasHook(\SwissKnife202606\PropertyHookType::Get)) {
