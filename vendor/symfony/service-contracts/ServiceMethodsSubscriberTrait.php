 ...
 */
namespace SwissKnife202605\Symfony\Contracts\Service;

use SwissKnife202605\Psr\Container\ContainerInterface;
use SwissKnife202605\Symfony\Contracts\Service\Attribute\Required;
use SwissKnife202605\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices() : array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (\PHP_VERSION_ID < 80400 || !$reflector->hasHook(\SwissKnife202605\PropertyHookType::Get)) {
