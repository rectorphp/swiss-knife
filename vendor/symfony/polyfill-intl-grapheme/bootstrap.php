...
if (!\function_exists('SwissKnife202605\\grapheme_str_split')) {
    function grapheme_str_split(string $string, int $length = 1)
    {
        return p\Grapheme::grapheme_str_split($string, $length);
    }
}
if (!\function_exists('SwissKnife202605\\grapheme_levenshtein')) {
...
if (!\function_exists('SwissKnife202605\\grapheme_strrev')) {
