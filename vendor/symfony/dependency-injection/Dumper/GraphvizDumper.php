 ...
 */
class GraphvizDumper extends \EasyCI20220305\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var mixed[]
     */
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \EasyCI20220305\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \EasyCI20220305\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\EasyCI20220305\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \EasyCI20220305\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \EasyCI20220305\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \EasyCI20220305\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \EasyCI20220305\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
