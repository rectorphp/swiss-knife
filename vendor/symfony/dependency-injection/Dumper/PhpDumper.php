...
use EasyCI202210\Composer\Autoload\ClassLoader;
use EasyCI202210\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
use EasyCI202210\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use EasyCI202210\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use EasyCI202210\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use EasyCI202210\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use EasyCI202210\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use EasyCI202210\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use EasyCI202210\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use EasyCI202210\Symfony\Component\DependencyInjection\Exception\LogicException;
use EasyCI202210\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use EasyCI202210\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use EasyCI202210\Symfony\Component\DependencyInjection\ExpressionLanguage;
use EasyCI202210\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use EasyCI202210\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use EasyCI202210\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use EasyCI202210\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use EasyCI202210\Symfony\Component\DependencyInjection\TypedReference;
use EasyCI202210\Symfony\Component\DependencyInjection\Variable;
use EasyCI202210\Symfony\Component\ErrorHandler\DebugClassLoader;
use EasyCI202210\Symfony\Component\ExpressionLanguage\Expression;
use EasyCI202210\Symfony\Component\HttpKernel\Kernel;
/**
...
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use EasyCI202210\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\EasyCI202210\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
