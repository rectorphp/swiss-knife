...
use EasyCI202211\Composer\Autoload\ClassLoader;
use EasyCI202211\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
use EasyCI202211\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use EasyCI202211\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use EasyCI202211\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use EasyCI202211\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use EasyCI202211\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use EasyCI202211\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use EasyCI202211\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use EasyCI202211\Symfony\Component\DependencyInjection\Exception\LogicException;
use EasyCI202211\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use EasyCI202211\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use EasyCI202211\Symfony\Component\DependencyInjection\ExpressionLanguage;
use EasyCI202211\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use EasyCI202211\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use EasyCI202211\Symfony\Component\DependencyInjection\Loader\FileLoader;
...
use EasyCI202211\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use EasyCI202211\Symfony\Component\DependencyInjection\TypedReference;
use EasyCI202211\Symfony\Component\DependencyInjection\Variable;
use EasyCI202211\Symfony\Component\ErrorHandler\DebugClassLoader;
use EasyCI202211\Symfony\Component\ExpressionLanguage\Expression;
use EasyCI202211\Symfony\Component\HttpKernel\Kernel;
/**
...
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use EasyCI202211\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\EasyCI202211\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
