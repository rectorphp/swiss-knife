 ...
 */
namespace EasyCI20220608\Symfony\Component\DependencyInjection;

use EasyCI20220608\Composer\InstalledVersions;
use EasyCI20220608\Symfony\Component\Config\Resource\ClassExistenceResource;
use EasyCI20220608\Symfony\Component\Config\Resource\ComposerResource;
use EasyCI20220608\Symfony\Component\Config\Resource\DirectoryResource;
use EasyCI20220608\Symfony\Component\Config\Resource\FileExistenceResource;
use EasyCI20220608\Symfony\Component\Config\Resource\FileResource;
use EasyCI20220608\Symfony\Component\Config\Resource\GlobResource;
use EasyCI20220608\Symfony\Component\Config\Resource\ReflectionClassResource;
use EasyCI20220608\Symfony\Component\Config\Resource\ResourceInterface;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use EasyCI20220608\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use EasyCI20220608\Symfony\Component\DependencyInjection\Attribute\Target;
use EasyCI20220608\Symfony\Component\DependencyInjection\Compiler\Compiler;
use EasyCI20220608\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use EasyCI20220608\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use EasyCI20220608\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use EasyCI20220608\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use EasyCI20220608\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use EasyCI20220608\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use EasyCI20220608\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use EasyCI20220608\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use EasyCI20220608\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use EasyCI20220608\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use EasyCI20220608\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use EasyCI20220608\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use EasyCI20220608\Symfony\Component\ExpressionLanguage\Expression;
use EasyCI20220608\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    */
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\EasyCI20220608\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
