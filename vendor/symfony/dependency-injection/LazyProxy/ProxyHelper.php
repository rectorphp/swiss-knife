 ...
 */
namespace EasyCI202212\Symfony\Component\DependencyInjection\LazyProxy;

trigger_deprecation('symfony/dependency-injection', '6.2', 'The "%s" class is deprecated, use "%s" instead.', ProxyHelper::class, \EasyCI202212\Symfony\Component\VarExporter\ProxyHelper::class);
/**
