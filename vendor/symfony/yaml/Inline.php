 ...
 */
namespace SwissKnife202508\Symfony\Component\Yaml;

use SwissKnife202508\Symfony\Component\Yaml\Exception\DumpException;
use SwissKnife202508\Symfony\Component\Yaml\Exception\ParseException;
use SwissKnife202508\Symfony\Component\Yaml\Tag\TaggedValue;
/**
            ...
            case \in_array($scalar[0], ['+', '-', '.'], \true) || \is_numeric($scalar[0]):
                ...
                switch (\true) {
                    ...
                    case Parser::preg_match(self::getTimestampRegex(), $scalar):
                        ...
                        } catch (\SwissKnife202508\DateRangeError|\ValueError $exception) {
                            // no-op
                        }
