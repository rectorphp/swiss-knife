...
if (\extension_loaded('mbstring')) {
    if (!\function_exists('SwissKnife202601\\mb_ucfirst')) {
        function mb_ucfirst(string $string, ?string $encoding = null) : string
        {
            return p\Php84::mb_ucfirst($string, $encoding);
        }
    }
    if (!\function_exists('SwissKnife202601\\mb_lcfirst')) {
        function mb_lcfirst(string $string, ?string $encoding = null) : string
        {
            return p\Php84::mb_lcfirst($string, $encoding);
        }
    }
    if (!\function_exists('SwissKnife202601\\mb_trim')) {
    ...
    if (!\function_exists('SwissKnife202601\\mb_ltrim')) {
    ...
    if (!\function_exists('SwissKnife202601\\mb_rtrim')) {
...
if (\extension_loaded('bcmath')) {
    if (!\function_exists('SwissKnife202601\\bcdivmod')) {
...
if (\extension_loaded('intl') && !\function_exists('SwissKnife202601\\grapheme_str_split')) {
