...
use EasyCI20220605\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \EasyCI20220605\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\EasyCI20220605\Symfony\Component\Finder\Finder::class)) {
        ...
        $finder = new \EasyCI20220605\Symfony\Component\Finder\Finder();
        $regex = \EasyCI20220605\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
