...
use EasyCI20220606\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \EasyCI20220606\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\EasyCI20220606\Symfony\Component\Finder\Finder::class)) {
        ...
        $regex = \EasyCI20220606\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
