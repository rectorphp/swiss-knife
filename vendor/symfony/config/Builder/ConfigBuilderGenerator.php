 ...
 */
namespace EasyCI202209\Symfony\Component\Config\Builder;

use EasyCI202209\Symfony\Component\Config\Definition\ArrayNode;
use EasyCI202209\Symfony\Component\Config\Definition\BooleanNode;
...
use EasyCI202209\Symfony\Component\Config\Definition\FloatNode;
use EasyCI202209\Symfony\Component\Config\Definition\IntegerNode;
...
use EasyCI202209\Symfony\Component\Config\Definition\ScalarNode;
use EasyCI202209\Symfony\Component\Config\Definition\VariableNode;
use EasyCI202209\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('EasyCI202209\\Symfony\\Config', $rootNode->getName());
