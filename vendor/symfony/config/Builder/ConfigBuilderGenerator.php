 ...
 */
namespace EasyCI202208\Symfony\Component\Config\Builder;

use EasyCI202208\Symfony\Component\Config\Definition\ArrayNode;
use EasyCI202208\Symfony\Component\Config\Definition\BooleanNode;
...
use EasyCI202208\Symfony\Component\Config\Definition\FloatNode;
use EasyCI202208\Symfony\Component\Config\Definition\IntegerNode;
...
use EasyCI202208\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('EasyCI202208\\Symfony\\Config', $rootNode->getName());
