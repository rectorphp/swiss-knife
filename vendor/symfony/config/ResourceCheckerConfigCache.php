 ...
 */
class ResourceCheckerConfigCache implements \EasyCI20220522\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \EasyCI20220522\Symfony\Component\Filesystem\Filesystem();
