...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\EasyCI20220202\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function () {
            throw new \EasyCI20220202\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
