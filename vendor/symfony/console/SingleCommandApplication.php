 ...
 */
class SingleCommandApplication extends \EasyCI20220501\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function run(\EasyCI20220501\Symfony\Component\Console\Input\InputInterface $input = null, \EasyCI20220501\Symfony\Component\Console\Output\OutputInterface $output = null) : int
    {
        ...
        $application = new \EasyCI20220501\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
