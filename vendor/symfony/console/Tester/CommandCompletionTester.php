...
{
    private $command;
    public function __construct(\EasyCI20220501\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function complete(array $input) : array
    {
        ...
        $completionInput = \EasyCI20220501\Symfony\Component\Console\Completion\CompletionInput::fromTokens($input, $currentIndex);
