 ...
 */
class ListCommand extends \EasyCI20220604\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('list')->setDefinition([new \EasyCI20220604\Symfony\Component\Console\Input\InputArgument('namespace', \EasyCI20220604\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \EasyCI20220604\Symfony\Component\Console\Input\InputOption('raw', null, \EasyCI20220604\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \EasyCI20220604\Symfony\Component\Console\Input\InputOption('format', null, \EasyCI20220604\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \EasyCI20220604\Symfony\Component\Console\Input\InputOption('short', null, \EasyCI20220604\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To skip describing commands\' arguments')])->setDescription('List commands')->setHelp(<<<'EOF'
