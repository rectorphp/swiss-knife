 ...
 */
final class LazyCommand extends \EasyCI20220206\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\EasyCI20220206\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\EasyCI20220206\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
