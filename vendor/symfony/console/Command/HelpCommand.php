 ...
 */
class HelpCommand extends \EasyCI20220206\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \EasyCI20220206\Symfony\Component\Console\Input\InputArgument('command_name', \EasyCI20220206\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \EasyCI20220206\Symfony\Component\Console\Input\InputOption('format', null, \EasyCI20220206\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \EasyCI20220206\Symfony\Component\Console\Input\InputOption('raw', null, \EasyCI20220206\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Display help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\EasyCI20220206\Symfony\Component\Console\Command\Command $command)
    {
