...
use EasyCI20220604\Symfony\Component\Console\Formatter\NullOutputFormatter;
 ...
 */
class NullOutput implements \EasyCI20220604\Symfony\Component\Console\Output\OutputInterface
{
    private $formatter;
    /**
     * {@inheritdoc}
    ...
    public function getFormatter() : \EasyCI20220604\Symfony\Component\Console\Formatter\OutputFormatterInterface
    {
        ...
        return $this->formatter = $this->formatter ?? new \EasyCI20220604\Symfony\Component\Console\Formatter\NullOutputFormatter();
    }
    /**
     * {@inheritdoc}
     */
