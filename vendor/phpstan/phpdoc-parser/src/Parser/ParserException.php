...
class ParserException extends \Exception
{
    ...
    public function __construct(string $currentTokenValue, int $currentTokenType, int $currentOffset, int $expectedTokenType)
    {
        ...
        \assert($json !== \false);
        parent::__construct(\sprintf('Unexpected token %s, expected %s at offset %d', $json, \EasyCI20220313\PHPStan\PhpDocParser\Lexer\Lexer::TOKEN_LABELS[$expectedTokenType], $currentOffset));
    }
