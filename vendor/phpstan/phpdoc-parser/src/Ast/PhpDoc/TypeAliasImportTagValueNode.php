...
class TypeAliasImportTagValueNode implements \EasyCI20220224\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var string */
    ...
    /** @var string|null */
    public $importedAs;
    public function __construct(string $importedAlias, \EasyCI20220224\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode $importedFrom, ?string $importedAs)
    {
