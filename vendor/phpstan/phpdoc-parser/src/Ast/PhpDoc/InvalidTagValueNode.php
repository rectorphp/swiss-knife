...
use EasyCI20220529\PHPStan\PhpDocParser\Parser\ParserException;
 ...
 */
class InvalidTagValueNode implements \EasyCI20220529\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    ...
    public function __construct(string $value, \EasyCI20220529\PHPStan\PhpDocParser\Parser\ParserException $exception)
    {
        $this->value = $value;
    ...
    public function __get(string $name)
    {
        ...
        return new \EasyCI20220529\PHPStan\PhpDocParser\Parser\ParserException(...$this->exceptionArgs);
    }
