...
use EasyCI20220520\PHPStan\PhpDocParser\Parser\ParserException;
 ...
 */
class InvalidTagValueNode implements \EasyCI20220520\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    ...
    public function __construct(string $value, \EasyCI20220520\PHPStan\PhpDocParser\Parser\ParserException $exception)
    {
        $this->value = $value;
    ...
    public function __get(string $name)
    {
        ...
        return new \EasyCI20220520\PHPStan\PhpDocParser\Parser\ParserException(...$this->exceptionArgs);
    }
