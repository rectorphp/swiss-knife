...
class MethodTagValueNode implements \EasyCI20220503\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var bool */
    public $isStatic;
    ...
    public $description;
    public function __construct(bool $isStatic, ?\EasyCI20220503\PHPStan\PhpDocParser\Ast\Type\TypeNode $returnType, string $methodName, array $parameters, string $description)
    {
