...
use EasyCI20220525\Composer\EventDispatcher\Event;
use EasyCI20220525\Composer\Package\PackageInterface;
class PatchEvent extends \EasyCI20220525\Composer\EventDispatcher\Event
{
    /**
     ...
     */
    public function __construct($eventName, \EasyCI20220525\Composer\Package\PackageInterface $package, $url, $description)
    {
