...
namespace EasyCI20220115\Symplify\EasyCI\StaticDetector\Command;
...
use EasyCI20220115\Symplify\EasyCI\StaticDetector\Collector\StaticNodeCollector;
use EasyCI20220115\Symplify\EasyCI\StaticDetector\Output\StaticReportReporter;
use EasyCI20220115\Symplify\EasyCI\StaticDetector\StaticScanner;
...
final class DetectStaticCommand extends \EasyCI20220115\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220115\Symplify\EasyCI\StaticDetector\StaticScanner $staticScanner, \EasyCI20220115\Symplify\EasyCI\StaticDetector\Collector\StaticNodeCollector $staticNodeCollector, \EasyCI20220115\Symplify\EasyCI\StaticDetector\Output\StaticReportReporter $staticReportReporter)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220115\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'One or more directories to detect static in');
