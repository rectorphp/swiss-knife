...
final class UnusedClassReporter
{
    ...
    public function __construct(\EasyCI20220414\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function reportResult(array $unusedFilesWithClasses, array $existingFilesWithClasses) : int
    {
        ...
        if ($unusedFilesWithClasses === []) {
            ...
            return \EasyCI20220414\Symfony\Component\Console\Command\Command::SUCCESS;
        }
        ...
        return \EasyCI20220414\Symfony\Component\Console\Command\Command::FAILURE;
    }
}
