...
final class ClassNameNodeVisitor extends \EasyCI20220116\PhpParser\NodeVisitorAbstract
{
    /**
     * @var string
    ...
    public function enterNode(\EasyCI20220116\PhpParser\Node $node)
    {
        ...
        return \EasyCI20220116\PhpParser\NodeTraverser::DONT_TRAVERSE_CURRENT_AND_CHILDREN;
    }
    public function getClassName() : ?string
    {
        return $this->className;
    }
    private function hasApiTag(\EasyCI20220116\PhpParser\Node\Stmt\ClassLike $classLike) : bool
    {
        $doc = $classLike->getDocComment();
        if (!$doc instanceof \EasyCI20220116\PhpParser\Comment\Doc) {
            return \false;
        }
        $matches = \EasyCI20220116\Nette\Utils\Strings::match($doc->getText(), self::API_TAG_REGEX);
        return $matches !== null;
    }
}
