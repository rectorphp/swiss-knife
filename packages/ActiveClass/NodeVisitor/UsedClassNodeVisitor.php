...
final class UsedClassNodeVisitor extends \EasyCI20220308\PhpParser\NodeVisitorAbstract
{
    /**
     * @var string[]
     */
    ...
    private function isNonNameNode(\EasyCI20220308\PhpParser\Node\Name $name) : bool
    {
        // skip nodes that are not part of class names
        $parent = $name->getAttribute(\EasyCI20220308\Symplify\Astral\ValueObject\AttributeKey::PARENT);
        if ($parent instanceof \EasyCI20220308\PhpParser\Node\Stmt\Namespace_) {
            return \true;
        }
        return $parent instanceof \EasyCI20220308\PhpParser\Node\Stmt\ClassMethod;
    }
}
