...
final class UseImportsResolver
{
    ...
    public function __construct(\EasyCI20220511\PhpParser\Parser $parser, \Symplify\EasyCI\ActiveClass\NodeDecorator\FullyQualifiedNameNodeDecorator $fullyQualifiedNameNodeDecorator)
    {
        $this->parser = $parser;
     ...
     * @return string[]
     */
    public function resolve(\EasyCI20220511\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo) : array
    {
        ...
        $nodeTraverser = new \EasyCI20220511\PhpParser\NodeTraverser();
