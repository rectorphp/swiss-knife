...
final class UseImportsResolver
{
    ...
    public function __construct(\EasyCI20220523\PhpParser\Parser $parser, \Symplify\EasyCI\ActiveClass\NodeDecorator\FullyQualifiedNameNodeDecorator $fullyQualifiedNameNodeDecorator)
    {
        $this->parser = $parser;
     ...
     * @return string[]
     */
    public function resolve(\EasyCI20220523\Symplify\SmartFileSystem\SmartFileInfo $phpFileInfo) : array
    {
        ...
        $nodeTraverser = new \EasyCI20220523\PhpParser\NodeTraverser();
