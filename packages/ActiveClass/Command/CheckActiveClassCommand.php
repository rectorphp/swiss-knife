...
use EasyCI20220522\Symplify\PackageBuilder\Console\Command\CommandNaming;
use EasyCI20220522\Symplify\PackageBuilder\Parameter\ParameterProvider;
use EasyCI20220522\Symplify\SmartFileSystem\Finder\SmartFinder;
final class CheckActiveClassCommand extends \EasyCI20220522\Symfony\Component\Console\Command\Command
{
    /**
    ...
    public function __construct(\EasyCI20220522\Symplify\SmartFileSystem\Finder\SmartFinder $smartFinder, \Symplify\EasyCI\ActiveClass\Finder\ClassNamesFinder $classNamesFinder, \Symplify\EasyCI\ActiveClass\UseImportsResolver $useImportsResolver, \Symplify\EasyCI\ActiveClass\Filtering\PossiblyUnusedClassesFilter $possiblyUnusedClassesFilter, \Symplify\EasyCI\ActiveClass\Reporting\UnusedClassReporter $unusedClassReporter, \EasyCI20220522\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \EasyCI20220522\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    {
        $this->setName(\EasyCI20220522\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
        $this->setDescription('Check classes that are not used in any config and in the code');
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220522\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220522\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'One or more paths with templates');
    }
