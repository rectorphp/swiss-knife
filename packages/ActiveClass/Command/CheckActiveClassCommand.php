...
final class CheckActiveClassCommand extends \EasyCI20220524\Symfony\Component\Console\Command\Command
{
    /**
    ...
    public function __construct(\EasyCI20220524\Symplify\SmartFileSystem\Finder\SmartFinder $smartFinder, \Symplify\EasyCI\ActiveClass\Finder\ClassNamesFinder $classNamesFinder, \Symplify\EasyCI\ActiveClass\UseImportsResolver $useImportsResolver, \Symplify\EasyCI\ActiveClass\Filtering\PossiblyUnusedClassesFilter $possiblyUnusedClassesFilter, \Symplify\EasyCI\ActiveClass\Reporting\UnusedClassReporter $unusedClassReporter, \EasyCI20220524\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \EasyCI20220524\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220524\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220524\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'One or more paths with templates');
    }
