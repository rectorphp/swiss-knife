...
namespace EasyCI20220115\Symplify\EasyCI\Config\Command;
...
use EasyCI20220115\Symplify\EasyCI\Config\Application\ClassAndConstantExistanceFileProcessor;
use EasyCI20220115\Symplify\EasyCI\Console\Output\FileErrorsReporter;
use EasyCI20220115\Symplify\EasyCI\ValueObject\ConfigFileSuffixes;
...
final class CheckConfigCommand extends \EasyCI20220115\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220115\Symplify\EasyCI\Config\Application\ClassAndConstantExistanceFileProcessor $classAndConstantExistanceFileProcessor, \EasyCI20220115\Symplify\EasyCI\Console\Output\FileErrorsReporter $fileErrorsReporter)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220115\Symplify\PackageBuilder\ValueObject\Option::SOURCES, \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to directories or files to check');
    }
    ...
    {
        /** @var string[] $sources */
        $sources = (array) $input->getArgument(\EasyCI20220115\Symplify\PackageBuilder\ValueObject\Option::SOURCES);
        $fileInfos = $this->smartFinder->find($sources, \EasyCI20220115\Symplify\EasyCI\ValueObject\ConfigFileSuffixes::provideRegex(), ['Fixture']);
        $message = \sprintf('Checking %d files with "%s" suffixes', \count($fileInfos), \implode('", "', \EasyCI20220115\Symplify\EasyCI\ValueObject\ConfigFileSuffixes::SUFFIXES));
