...
final class NonExistingClassConfigFileAnalyzer implements \Symplify\EasyCI\Config\Contract\ConfigFileAnalyzerInterface
{
    ...
    public function __construct(\Symplify\EasyCI\Config\ClassExtractor $classExtractor, \EasyCI20220307\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker)
    {
     ...
     * @return string[]
     */
    private function extractFromFileInfo(\EasyCI20220307\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
