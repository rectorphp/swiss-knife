...
use EasyCI20220207\Nette\Neon\Node\EntityNode;
...
final class NeonFilesProcessor implements \Symplify\EasyCI\Contract\Application\FileProcessorInterface
{
     ...
     */
    private $decoder;
    public function __construct(\EasyCI20220207\Nette\Neon\Decoder $decoder)
    {
     ...
     * @return FileErrorInterface[]
     */
    private function process(\EasyCI20220207\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
        $fileErrors = [];
     ...
     * @return FileErrorInterface[]
     */
    private function processServicesSection(\EasyCI20220207\Nette\Neon\Node $servicesNode, \EasyCI20220207\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
        $fileErrors = [];
        if (!$servicesNode instanceof \EasyCI20220207\Nette\Neon\Node\ArrayNode) {
            return [];
        }
        foreach ($servicesNode->items as $serviceItem) {
            if ($serviceItem->value instanceof \EasyCI20220207\Nette\Neon\Node\EntityNode) {
    ...
    private function createErrorMessageFromNeonEntity(\EasyCI20220207\Nette\Neon\Node\EntityNode $entityNode) : string
    {
