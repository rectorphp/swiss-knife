...
final class DetectUnitTestsCommand extends \EasyCI20220516\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\Symplify\EasyCI\Testing\Printer\PHPUnitXmlPrinter $phpunitXmlPrinter, \EasyCI20220516\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \EasyCI20220516\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\EasyCI\Testing\UnitTestFilePathsFinder $unitTestFilePathsFinder)
    {
...
They depend only on bare PHPUnit test case, but not on KernelTestCase. Move the generated file to your phpunit.xml test group.');
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220516\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220516\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to directory with tests');
    }
    protected function execute(\EasyCI20220516\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220516\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        \EasyCI20220516\Webmozart\Assert\Assert::isArray($sources);
        \EasyCI20220516\Webmozart\Assert\Assert::allString($sources);
