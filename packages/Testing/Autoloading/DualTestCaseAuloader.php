...
final class DualTestCaseAuloader
{
    ...
    public function autoload() : void
    {
        if (!\class_exists(self::UNDERSCORED_TEST_CASE_CLASS)) {
            ...
            \class_alias('EasyCI20220602\\PHPUnit\\Framework\\TestCase', self::UNDERSCORED_TEST_CASE_CLASS);
            return;
        }
        if (!\class_exists('EasyCI20220602\\PHPUnit\\Framework\\TestCase')) {
            // alias old test case to new one
            \class_alias(self::UNDERSCORED_TEST_CASE_CLASS, 'EasyCI20220602\\PHPUnit\\Framework\\TestCase');
        }
    }
}
