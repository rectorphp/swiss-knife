...
use EasyCI20220219\Symfony\Bundle\FrameworkBundle\Test\KernelTestCase;
final class UnitTestFilter
{
    /**
     * @var string[]|class-string<KernelTestCase>[]
     */
    private const NON_UNIT_TEST_CASE_CLASSES = [\EasyCI20220219\Symfony\Bundle\FrameworkBundle\Test\KernelTestCase::class, 'EasyCI20220219\\Symfony\\Component\\Form\\Test\\TypeTestCase'];
    /**
    ...
    {
        if (!\is_a($class, \EasyCI20220219\PHPUnit\Framework\TestCase::class, \true)) {
            return \false;
        }
