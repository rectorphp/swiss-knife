...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220302\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220302\Symfony\Component\Console\Input\InputInterface $input) : void
    {
