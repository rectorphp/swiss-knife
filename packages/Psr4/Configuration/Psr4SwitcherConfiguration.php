...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220216\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220216\Symfony\Component\Console\Input\InputInterface $input) : void
    {
