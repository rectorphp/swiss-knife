...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220531\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220531\Symfony\Component\Console\Input\InputInterface $input) : void
    {
