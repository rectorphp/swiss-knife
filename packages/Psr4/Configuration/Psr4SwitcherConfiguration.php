...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220306\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220306\Symfony\Component\Console\Input\InputInterface $input) : void
    {
