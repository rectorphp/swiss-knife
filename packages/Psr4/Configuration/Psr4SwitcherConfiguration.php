...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220204\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220204\Symfony\Component\Console\Input\InputInterface $input) : void
    {
