...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220131\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220131\Symfony\Component\Console\Input\InputInterface $input) : void
    {
