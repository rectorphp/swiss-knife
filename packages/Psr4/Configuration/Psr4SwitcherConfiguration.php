...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220605\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220605\Symfony\Component\Console\Input\InputInterface $input) : void
    {
