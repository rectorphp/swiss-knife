...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220516\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220516\Symfony\Component\Console\Input\InputInterface $input) : void
    {
