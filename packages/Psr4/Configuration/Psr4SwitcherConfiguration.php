...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220206\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220206\Symfony\Component\Console\Input\InputInterface $input) : void
    {
