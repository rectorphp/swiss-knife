...
final class Psr4SwitcherConfiguration
{
    ...
    public function __construct(\EasyCI20220514\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
    ...
    public function loadFromInput(\EasyCI20220514\Symfony\Component\Console\Input\InputInterface $input) : void
    {
