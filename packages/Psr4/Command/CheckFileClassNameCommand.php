...
final class CheckFileClassNameCommand extends \EasyCI20220325\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute(\EasyCI20220325\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220325\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($classesToFiles as $class => $file) {
            ...
            $shortClassName = \EasyCI20220325\Nette\Utils\Strings::after($class, '\\', -1);
        ...
        foreach ($missMatchingClassNamesByFiles as $file => $class) {
            $fileInfo = new \EasyCI20220325\Symplify\SmartFileSystem\SmartFileInfo($file);
