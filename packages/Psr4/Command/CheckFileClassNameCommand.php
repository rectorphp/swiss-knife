...
final class CheckFileClassNameCommand extends \EasyCI20220205\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\Psr4\ValueObject\Option::SOURCES, \EasyCI20220205\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220205\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to source');
    }
    protected function execute(\EasyCI20220205\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220205\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($classesToFiles as $class => $file) {
            ...
            $shortClassName = \EasyCI20220205\Nette\Utils\Strings::after($class, '\\', -1);
        ...
        foreach ($missMatchingClassNamesByFiles as $file => $class) {
            $fileInfo = new \EasyCI20220205\Symplify\SmartFileSystem\SmartFileInfo($file);
