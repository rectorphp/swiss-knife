...
final class CheckFileClassNameCommand extends \EasyCI20220125\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute(\EasyCI20220125\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220125\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($classesToFiles as $class => $file) {
            ...
            $shortClassName = \EasyCI20220125\Nette\Utils\Strings::after($class, '\\', -1);
        ...
        foreach ($missMatchingClassNamesByFiles as $file => $class) {
            $fileInfo = new \EasyCI20220125\Symplify\SmartFileSystem\SmartFileInfo($file);
