...
final class GeneratePsr4ToPathsCommand extends \EasyCI20220306\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Symplify\EasyCI\Psr4\ValueObject\Option::COMPOSER_JSON, null, \EasyCI20220306\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to composer.json');
    }
