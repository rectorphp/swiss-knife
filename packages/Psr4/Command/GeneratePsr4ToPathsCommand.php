...
final class GeneratePsr4ToPathsCommand extends \EasyCI20220514\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\Psr4\ValueObject\Option::SOURCES, \EasyCI20220514\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220514\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to source');
        $this->addOption(\Symplify\EasyCI\Psr4\ValueObject\Option::COMPOSER_JSON, null, \EasyCI20220514\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to composer.json');
    }
