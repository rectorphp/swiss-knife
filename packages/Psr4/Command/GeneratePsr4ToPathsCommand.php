...
use EasyCI20220115\Symplify\EasyCI\Psr4\Json\JsonAutoloadPrinter;
use EasyCI20220115\Symplify\EasyCI\Psr4\Psr4Filter;
...
use EasyCI20220115\Symplify\EasyCI\Psr4\ValueObjectFactory\Psr4NamespaceToPathFactory;
...
final class GeneratePsr4ToPathsCommand extends \EasyCI20220115\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\EasyCI20220115\Symplify\EasyCI\Psr4\Configuration\Psr4SwitcherConfiguration $psr4SwitcherConfiguration, \EasyCI20220115\Symplify\EasyCI\Psr4\RobotLoader\PhpClassLoader $phpClassLoader, \EasyCI20220115\Symplify\EasyCI\Psr4\ValueObjectFactory\Psr4NamespaceToPathFactory $psr4NamespaceToPathFactory, \EasyCI20220115\Symplify\EasyCI\Psr4\Psr4Filter $psr4Filter, \EasyCI20220115\Symplify\EasyCI\Psr4\Json\JsonAutoloadPrinter $jsonAutoloadPrinter)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220115\Symplify\EasyCI\Psr4\ValueObject\Option::SOURCES, \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220115\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to source');
        $this->addOption(\EasyCI20220115\Symplify\EasyCI\Psr4\ValueObject\Option::COMPOSER_JSON, null, \EasyCI20220115\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to composer.json');
    }
    protected function execute(\EasyCI20220115\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220115\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($classesToFiles as $class => $file) {
            ...
            if (!$psr4NamespaceToPath instanceof \EasyCI20220115\Symplify\EasyCI\Psr4\ValueObject\Psr4NamespaceToPath) {
