...
final class JsonAutoloadPrinter
{
    ...
    public function createJsonAutoloadContent(array $psr4NamespaceToPaths) : string
    {
        ...
        $composerJson = [\EasyCI20220325\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD => ['psr-4' => $normalizedJsonArray]];
        return \EasyCI20220325\Nette\Utils\Json::encode($composerJson, \EasyCI20220325\Nette\Utils\Json::PRETTY);
    }
}
