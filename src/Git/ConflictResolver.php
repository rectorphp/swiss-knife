...
final class ConflictResolver
{
    ...
    public function extractFromFileInfo(\EasyCI20220524\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : int
    {
        $conflictsMatch = \EasyCI20220524\Nette\Utils\Strings::matchAll($fileInfo->getContents(), self::CONFLICT_REGEX);
