...
use SwissKnife202605\PhpParser\Node;
use SwissKnife202605\PhpParser\Node\Arg;
use SwissKnife202605\PhpParser\Node\Expr\ClassConstFetch;
use SwissKnife202605\PhpParser\Node\Expr\MethodCall;
use SwissKnife202605\PhpParser\Node\Expr\StaticCall;
use SwissKnife202605\PhpParser\Node\Identifier;
use SwissKnife202605\PhpParser\Node\Name;
use SwissKnife202605\PhpParser\NodeVisitorAbstract;
final class MockedClassNameCollectingNodeVisitor extends NodeVisitorAbstract
{
    ...
    public function enterNode(Node $node) : ?Node
    {
        ...
        $mockMethodNames = [
            ...
            'spy',
            // https://github.com/mockery/mockery/blob/73a9714716f87510a7c2add9931884188e657541/library/Mockery.php#L675, https://github.com/laravel/framework/blob/4ca4a16772b2e89233b3606badefae34003e1538/src/Illuminate/Foundation/Testing/Concerns/InteractsWithContainer.php#L93
            'createStub',
            // https://github.com/sebastianbergmann/phpunit/blob/d72b735d34bbff2065cef80653cafbe31cb45ba0/src/Framework/TestCase.php#L2262
            'createStubForIntersectionOfInterfaces',
            // https://github.com/sebastianbergmann/phpunit/blob/d72b735d34bbff2065cef80653cafbe31cb45ba0/src/Framework/TestCase.php#L2285
