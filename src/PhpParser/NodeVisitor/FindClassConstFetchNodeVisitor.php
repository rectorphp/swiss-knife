...
use SwissKnife202507\PhpParser\Node;
use SwissKnife202507\PhpParser\Node\Expr;
use SwissKnife202507\PhpParser\Node\Expr\ClassConstFetch;
...
use SwissKnife202507\PhpParser\Node\Stmt\Trait_;
use SwissKnife202507\PhpParser\NodeTraverser;
use SwissKnife202507\PhpParser\NodeVisitorAbstract;
...
use ReflectionClass;
use SwissKnife202507\Webmozart\Assert\Assert;
