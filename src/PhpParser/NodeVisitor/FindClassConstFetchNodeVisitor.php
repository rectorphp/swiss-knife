...
use SwissKnife202504\PhpParser\Node\Expr\ClassConstFetch;
...
use SwissKnife202504\PhpParser\Node\Stmt\Trait_;
use SwissKnife202504\PhpParser\NodeTraverser;
use SwissKnife202504\PhpParser\NodeVisitorAbstract;
