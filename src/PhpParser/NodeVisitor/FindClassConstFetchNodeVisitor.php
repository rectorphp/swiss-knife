...
use SwissKnife202601\PhpParser\Node;
use SwissKnife202601\PhpParser\Node\Expr;
use SwissKnife202601\PhpParser\Node\Expr\ClassConstFetch;
...
use SwissKnife202601\PhpParser\Node\Stmt\Trait_;
use SwissKnife202601\PhpParser\NodeTraverser;
use SwissKnife202601\PhpParser\NodeVisitorAbstract;
