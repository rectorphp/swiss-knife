...
use SwissKnife202508\PhpParser\Node\Expr\Closure;
use SwissKnife202508\PhpParser\Node\Expr\MethodCall;
use SwissKnife202508\PhpParser\Node\Expr\Variable;
use SwissKnife202508\PhpParser\Node\Identifier;
use SwissKnife202508\PhpParser\Node\Name\FullyQualified;
...
use SwissKnife202508\PhpParser\Node\Stmt\Declare_;
use SwissKnife202508\PhpParser\Node\Stmt\DeclareDeclare;
