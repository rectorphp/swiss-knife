...
use SwissKnife202506\PhpParser\Node\Name\FullyQualified;
use SwissKnife202506\PhpParser\Node\Param;
use SwissKnife202506\PhpParser\Node\Scalar\LNumber;
use SwissKnife202506\PhpParser\Node\Stmt;
use SwissKnife202506\PhpParser\Node\Stmt\Declare_;
use SwissKnife202506\PhpParser\Node\Stmt\DeclareDeclare;
