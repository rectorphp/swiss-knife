...
use SwissKnife202605\PhpParser\Node\Expr\Closure;
use SwissKnife202605\PhpParser\Node\Expr\MethodCall;
use SwissKnife202605\PhpParser\Node\Expr\Variable;
use SwissKnife202605\PhpParser\Node\Identifier;
use SwissKnife202605\PhpParser\Node\Name\FullyQualified;
...
use SwissKnife202605\PhpParser\Node\Stmt\Declare_;
use SwissKnife202605\PhpParser\Node\Stmt\DeclareDeclare;
use SwissKnife202605\PhpParser\Node\Stmt\Expression;
use SwissKnife202605\PhpParser\Node\Stmt\Nop;
use SwissKnife202605\PhpParser\Node\Stmt\Return_;
