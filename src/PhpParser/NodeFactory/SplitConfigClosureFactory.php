...
use SwissKnife202606\PhpParser\Node\Expr\Closure;
use SwissKnife202606\PhpParser\Node\Expr\MethodCall;
use SwissKnife202606\PhpParser\Node\Expr\Variable;
use SwissKnife202606\PhpParser\Node\Identifier;
use SwissKnife202606\PhpParser\Node\Name\FullyQualified;
...
use SwissKnife202606\PhpParser\Node\Stmt\Declare_;
use SwissKnife202606\PhpParser\Node\Stmt\DeclareDeclare;
use SwissKnife202606\PhpParser\Node\Stmt\Expression;
