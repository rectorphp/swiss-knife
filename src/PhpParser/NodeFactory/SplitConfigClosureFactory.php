...
use SwissKnife202502\PhpParser\Node\Name\FullyQualified;
use SwissKnife202502\PhpParser\Node\Param;
use SwissKnife202502\PhpParser\Node\Scalar\LNumber;
use SwissKnife202502\PhpParser\Node\Stmt;
use SwissKnife202502\PhpParser\Node\Stmt\Declare_;
use SwissKnife202502\PhpParser\Node\Stmt\DeclareDeclare;
use SwissKnife202502\PhpParser\Node\Stmt\Expression;
use SwissKnife202502\PhpParser\Node\Stmt\Nop;
use SwissKnife202502\PhpParser\Node\Stmt\Return_;
