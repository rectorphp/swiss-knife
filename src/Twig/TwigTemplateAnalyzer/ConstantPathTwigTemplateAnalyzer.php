...
final class ConstantPathTwigTemplateAnalyzer implements \Symplify\EasyCI\Twig\Contract\TwigTemplateAnalyzerInterface
{
    ...
    public function analyze(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            $matches = \EasyCI20220305\Nette\Utils\Strings::matchAll($fileInfo->getContents(), self::PATH_WITH_NAME_REGEX, \PREG_OFFSET_CAPTURE);
     ...
     */
    private function resolveLineNumber(\EasyCI20220305\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, array $match) : int
    {
        $length = $match[0][1];
