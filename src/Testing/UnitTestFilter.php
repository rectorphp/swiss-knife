...
final class UnitTestFilter
{
     ...
     */
    private const NON_UNIT_TEST_CASE_CLASSES = ['SwissKnife202403\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase', 'SwissKnife202403\\Symfony\\Component\\Form\\Test\\TypeTestCase'];
    /**
    ...
    {
        if (!\is_a($class, 'SwissKnife202403\\PHPUnit\\Framework\\TestCase', \true) && !\is_a($class, 'SwissKnife202403\\PHPUnit_Framework_TestCase', \true)) {
            return \false;
        }
