...
final class UnitTestFilter
{
     ...
     */
    private const NON_UNIT_TEST_CASE_CLASSES = ['SwissKnife202501\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase', 'SwissKnife202501\\Symfony\\Component\\Form\\Test\\TypeTestCase'];
    /**
    ...
    {
        if (!\is_a($class, 'SwissKnife202501\\PHPUnit\\Framework\\TestCase', \true) && !\is_a($class, 'SwissKnife202501\\PHPUnit_Framework_TestCase', \true)) {
            return \false;
        }
