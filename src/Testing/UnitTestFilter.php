...
final class UnitTestFilter
{
     ...
     */
    private const NON_UNIT_TEST_CASE_CLASSES = ['SwissKnife202507\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase', 'SwissKnife202507\\Symfony\\Component\\Form\\Test\\TypeTestCase'];
    /**
    ...
    {
        if (!\is_a($class, 'SwissKnife202507\\PHPUnit\\Framework\\TestCase', \true) && !\is_a($class, 'SwissKnife202507\\PHPUnit_Framework_TestCase', \true)) {
            return \false;
        }
