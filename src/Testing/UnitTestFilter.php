...
final class UnitTestFilter
{
     ...
     */
    private const NON_UNIT_TEST_CASE_CLASSES = ['EasyCI202402\\Symfony\\Bundle\\FrameworkBundle\\Test\\KernelTestCase', 'EasyCI202402\\Symfony\\Component\\Form\\Test\\TypeTestCase'];
    /**
    ...
    {
        if (!\is_a($class, 'EasyCI202402\\PHPUnit\\Framework\\TestCase', \true) && !\is_a($class, 'EasyCI202402\\PHPUnit_Framework_TestCase', \true)) {
            return \false;
        }
