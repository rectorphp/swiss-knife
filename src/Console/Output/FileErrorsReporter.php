...
final class FileErrorsReporter
{
    ...
    public function __construct(\EasyCI20220221\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function report(array $fileErrors) : int
    {
        if ($fileErrors === []) {
            ...
            return \EasyCI20220221\Symfony\Component\Console\Command\Command::SUCCESS;
        }
        ...
        return \EasyCI20220221\Symfony\Component\Console\Command\Command::FAILURE;
    }
}
