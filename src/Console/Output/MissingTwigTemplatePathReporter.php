...
final class MissingTwigTemplatePathReporter
{
    ...
    public function __construct(\EasyCI20220605\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function report(array $errorMessages) : int
    {
        if ($errorMessages === []) {
            ...
            return \EasyCI20220605\Symfony\Component\Console\Command\Command::SUCCESS;
        }
        ...
        return \EasyCI20220605\Symfony\Component\Console\Command\Command::FAILURE;
    }
}
