...
final class CheckConflictsCommand extends \EasyCI20220403\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    {
        /** @var string[] $source */
        $source = (array) $input->getArgument(\EasyCI20220403\Symplify\PackageBuilder\ValueObject\Option::SOURCES);
