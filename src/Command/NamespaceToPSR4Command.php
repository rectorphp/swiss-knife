...
use SwissKnife202412\Symfony\Component\Finder\Finder;
...
final class NamespaceToPSR4Command extends Command
{
    ...
    {
        $finder = Finder::create()->files()->in([$path])->name('*.php')->sortByName()->filter(static fn(SplFileInfo $fileInfo): bool => \strpos($fileInfo->getContents(), 'class ') !== \false);
