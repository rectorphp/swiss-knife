...
final class ValidateFileLengthCommand extends \EasyCI20220306\Symfony\Component\Console\Command\Command
{
    /**
    ...
    public function __construct(\Symplify\EasyCI\Finder\ProjectFilesFinder $projectFilesFinder, \EasyCI20220306\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\EasyCI\Resolver\TooLongFilesResolver $tooLongFilesResolver)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\EasyCI20220306\Symplify\PackageBuilder\ValueObject\Option::SOURCES, \EasyCI20220306\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220306\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to project');
    }
    ...
    {
        /** @var string[] $sources */
        $sources = (array) $input->getArgument(\EasyCI20220306\Symplify\PackageBuilder\ValueObject\Option::SOURCES);
