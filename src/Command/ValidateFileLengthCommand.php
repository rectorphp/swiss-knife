...
use EasyCI20220115\Symplify\EasyCI\Finder\ProjectFilesFinder;
use EasyCI20220115\Symplify\EasyCI\Resolver\TooLongFilesResolver;
...
final class ValidateFileLengthCommand extends \EasyCI20220115\Symfony\Component\Console\Command\Command
{
    /**
    ...
    public function __construct(\EasyCI20220115\Symplify\EasyCI\Finder\ProjectFilesFinder $projectFilesFinder, \EasyCI20220115\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \EasyCI20220115\Symplify\EasyCI\Resolver\TooLongFilesResolver $tooLongFilesResolver)
    {
    ...
    protected function execute(\EasyCI20220115\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220115\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($tooLongFileInfos as $tooLongFileInfo) {
            $message = \sprintf('Paths for file "%s" has %d chars, but must be shorter than %d.', $tooLongFileInfo->getRealPath(), \strlen($tooLongFileInfo->getRealPath()), \EasyCI20220115\Symplify\EasyCI\Resolver\TooLongFilesResolver::MAX_FILE_LENGTH);
