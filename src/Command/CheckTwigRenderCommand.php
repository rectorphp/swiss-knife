...
final class CheckTwigRenderCommand extends \EasyCI20220130\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220130\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220130\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to project directories');
    }
