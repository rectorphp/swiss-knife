...
final class CheckTwigRenderCommand extends \EasyCI20220125\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220125\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220125\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to project directories');
    }
