...
final class CheckTwigRenderCommand extends \EasyCI20220305\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220305\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220305\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to project directories');
    }
