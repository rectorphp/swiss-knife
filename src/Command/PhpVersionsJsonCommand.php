...
final class PhpVersionsJsonCommand extends \EasyCI20220602\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::COMPOSER_JSON_FILE_PATH, \EasyCI20220602\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Path to composer.json', \getcwd() . '/composer.json');
    ...
    protected function execute(\EasyCI20220602\Symfony\Component\Console\Input\InputInterface $input, \EasyCI20220602\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $jsonContent = \EasyCI20220602\Nette\Utils\Json::encode($supportedPhpVersions);
