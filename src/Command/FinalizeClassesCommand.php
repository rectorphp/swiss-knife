...
use SwissKnife202601\Nette\Utils\Strings;
...
final class FinalizeClassesCommand extends Command
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption('dry-run', null, InputOption::VALUE_NONE, 'Do no change anything, only list classes about to be finalized. If there are classes to finalize, it will exit with code 1. Useful for CI.');
