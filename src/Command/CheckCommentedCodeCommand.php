...
final class CheckCommentedCodeCommand extends \EasyCI20220429\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
     * @var int
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\EasyCI\ValueObject\Option::SOURCES, \EasyCI20220429\Symfony\Component\Console\Input\InputArgument::REQUIRED | \EasyCI20220429\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'One or more paths to check');
        $this->setDescription('Checks code for commented snippets');
        $this->addOption(\Symplify\EasyCI\ValueObject\Option::LINE_LIMIT, null, \EasyCI20220429\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED | \EasyCI20220429\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'Amount of allowed comment lines in a row', self::DEFAULT_LINE_LIMIT);
    }
