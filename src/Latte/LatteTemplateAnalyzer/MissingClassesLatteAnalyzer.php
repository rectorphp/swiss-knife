 ...
 */
final class MissingClassesLatteAnalyzer implements \EasyCI20220115\Symplify\EasyCI\Latte\Contract\LatteTemplateAnalyzerInterface
{
    /**
    ...
    public function __construct(\EasyCI20220115\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker)
    {
    ...
    public function analyze(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $fileContents = \EasyCI20220115\Nette\Utils\Strings::replace($fileInfo->getContents(), self::SCRIPT_CONTENTS_REGEX, '');
            $classMatches = \EasyCI20220115\Nette\Utils\Strings::matchAll($fileContents, self::CLASS_REGEX);
            $varTypeInstanceOfClassMatches = \EasyCI20220115\Nette\Utils\Strings::matchAll($fileContents, self::VARTYPE_INSTANCEOF_CLASS_REGEX);
            ...
            foreach ($matches as $match) {
                ...
                $errors[] = new \EasyCI20220115\Symplify\EasyCI\ValueObject\FileError(\sprintf('Class "%s" not found', $class), $fileInfo);
            }
        }
        return $errors;
    }
