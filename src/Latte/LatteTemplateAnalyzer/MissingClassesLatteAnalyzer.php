...
final class MissingClassesLatteAnalyzer implements \Symplify\EasyCI\Latte\Contract\LatteTemplateAnalyzerInterface
{
    ...
    public function __construct(\EasyCI20220509\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker)
    {
    ...
    public function analyze(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $fileContents = \EasyCI20220509\Nette\Utils\Strings::replace($fileInfo->getContents(), self::SCRIPT_CONTENTS_REGEX, '');
            $classMatches = \EasyCI20220509\Nette\Utils\Strings::matchAll($fileContents, self::CLASS_REGEX);
            $varTypeInstanceOfClassMatches = \EasyCI20220509\Nette\Utils\Strings::matchAll($fileContents, self::VARTYPE_INSTANCEOF_CLASS_REGEX);
