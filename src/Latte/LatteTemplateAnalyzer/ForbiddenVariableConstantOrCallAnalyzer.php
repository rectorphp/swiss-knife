...
final class ForbiddenVariableConstantOrCallAnalyzer implements \Symplify\EasyCI\Latte\Contract\LatteTemplateAnalyzerInterface
{
     ...
     * @return FileErrorInterface[]
     */
    private function analyzeFileInfo(\EasyCI20220219\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : array
    {
        $matches = \EasyCI20220219\Nette\Utils\Strings::matchAll($fileInfo->getContents(), self::ON_VARIABLE_CALL_REGEX);
        $templateErrors = [];
