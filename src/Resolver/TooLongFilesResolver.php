...
final class TooLongFilesResolver
{
    ...
    {
        return \array_filter($fileInfos, function (\EasyCI20220509\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : bool {
            return $this->isFileContentLongerThan($fileInfo, self::MAX_FILE_LENGTH);
        });
    }
    private function isFileContentLongerThan(\EasyCI20220509\Symplify\SmartFileSystem\SmartFileInfo $fileInfo, int $maxFileLenght) : bool
    {
