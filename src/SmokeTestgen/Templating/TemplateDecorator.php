...
final class TemplateDecorator
{
    ...
    private function resolveKernelClass() : string
    {
        ...
        if (\class_exists('SwissKnife202606\\App\\Kernel')) {
            return 'SwissKnife202606\\App\\Kernel';
        }
        if (\class_exists('SwissKnife202606\\AppKernel')) {
            return 'AppKernel';
        }
        return 'Kernel';
    }
    ...
    private function resolveProjectTestsNamespace() : string
    {
        ...
        // fallback to default
        return 'SwissKnife202606\\App\\Tests';
    }
}
