...
final class TemplateDecorator
{
    ...
    private function resolveKernelClass() : string
    {
        ...
        if (\class_exists('SwissKnife202605\\App\\Kernel')) {
            return 'SwissKnife202605\\App\\Kernel';
        }
        if (\class_exists('SwissKnife202605\\AppKernel')) {
            return 'AppKernel';
        }
        return 'Kernel';
    }
    ...
    private function resolveProjectTestsNamespace() : string
    {
        ...
        // fallback to default
        return 'SwissKnife202605\\App\\Tests';
    }
}
