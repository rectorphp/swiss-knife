...
final class TemplatePathsResolver
{
     ...
     */
    private $smartFinder;
    public function __construct(\EasyCI20220121\Symplify\SmartFileSystem\Finder\SmartFinder $smartFinder)
    {
    ...
    private function findBundlePrefix(\EasyCI20220121\Symplify\SmartFileSystem\SmartFileInfo $templateFileInfo) : string
    {
        ...
        do {
            ...
            if ($foundFiles !== []) {
                ...
                $match = \EasyCI20220121\Nette\Utils\Strings::match($bundleFileRealPath, self::BUNDLE_NAME_REGEX);
    ...
    private function resolveRelativeTemplateFilepath(\EasyCI20220121\Symplify\SmartFileSystem\SmartFileInfo $templateFileInfo) : string
    {
        $match = \EasyCI20220121\Nette\Utils\Strings::match($templateFileInfo->getRealPath(), self::TEMPLATE_PATH_REGEX);
